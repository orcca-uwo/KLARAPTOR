...
/* Subroutine */ int dprtb2_(char *lab1, char *lab2, char *lab3, integer *nn, 
	integer *nval, integer *nlda, doublereal *reslts, integer *ldr1, 
	integer *ldr2, integer *nout, ftnlen lab1_len, ftnlen lab2_len, 
	ftnlen lab3_len)
{
    /* Format strings */
