...
/* Subroutine */ int ctimls_(char *line, integer *nm, integer *mval, integer *
	nn, integer *nval, integer *nns, integer *nsval, integer *nnb, 
	integer *nbval, integer *nxval, integer *nlda, integer *ldaval, real *
	timmin, complex *a, complex *copya, complex *b, complex *copyb, real *
	s, real *copys, real *opctbl, real *timtbl, real *flptbl, complex *
	work, real *rwork, integer *iwork, integer *nout, ftnlen line_len)
{
    /* Initialized data */

    static char subnam[6*5] = "CGELS " "CGELSX" "CGELSY" "CGELSS" "CGELSD";
    ...
    static char fmt_9999[] = "(///\002 ****** Results for \002,a,\002 *****"
	    "*\002)";
    static char fmt_9998[] = "(/\002 CGELS   : overall performance\002,/\002"
	    " comp. 1 : if M>=N, CGEQRF, QR factorization\002,/\002          "
	    " if M< N, CGELQF, QR factorization\002,/\002 comp. 2 : if M>=N, "
	    "CUNMQR, multiplication by\002,\002 reflectors\002,/\002         "
	    "  if M< N, CUNMLQ, multiplication by\002,\002 reflectors\002,"
	    "/\002 comp. 3 : CTRSM, solution of the triangular\002,\002 system"
	    "\002/,/\002 Types 4 to 6 are the conjugate transpose\002,\002 of"
	    " types 1 to 3\002)";
    static char fmt_9997[] = "(/\002 CGELSX  : overall performance\002,/\002"
	    " comp. 1 : CGEQPF, QR factorization with column\002,\002 pivoting"
	    "\002,/\002 comp. 2 : if RANK<N, CTZRQF, reduction to\002,\002 tr"
	    "iangular form\002,/\002 comp. 3 : CUNM2R, multiplication by refl"
	    "ectors\002,/\002 comp. 4 : CTRSM, solution of the triangular\002,"
	    "\002 system\002,/\002 comp. 5 : if RANK<N, CLATZM, multiplicatio"
	    "n by\002,\002 reflectors\002)";
    static char fmt_9996[] = "(/\002 CGELSY  : overall performance\002,/\002"
	    " comp. 1 : CGEQP3, QR factorization with column\002,\002 pivoting"
	    "\002,/\002 comp. 2 : if RANK<N, CTZRZF, reduction to\002,\002 tr"
	    "iangular form\002,/\002 comp. 3 : CUNMQR, multiplication by refl"
	    "ectors\002,/\002 comp. 4 : CTRSM, solution of the triangular\002,"
	    "\002 system\002,/\002 comp. 5 : if RANK<N, CUNMRZ, multiplicatio"
	    "n by\002,\002 reflectors\002)";
    static char fmt_9995[] = "(/\002 CGELSS: overall performance\002,/\002 c"
	    "omp. 1 : if M>>N, CGEQRF, QR factorization\002,/\002            "
	    "        CUNMQR, multiplication by\002,\002 reflectors\002,/\002 "
	    "          if N>>M, CGELQF, QL factorization\002,/\002 comp. 2 : "
	    "CGEBRD, reduction to bidiagonal form\002,/\002 comp. 3 : CUNMBR,"
	    " multiplication by left\002,\002 bidiagonalizing vectors\002,"
	    "/\002           CUNGBR, generation of right\002,\002 bidiagonali"
	    "zing vectors\002,/\002 comp. 4 : CBDSQR, singular value decompos"
	    "ition\002,\002 of the bidiagonal matrix\002,/\002 comp. 5 : mult"
	    "iplication by right bidiagonalizing\002,\002 vectors\002,/\002  "
	    "         (CGEMM or CGEMV, and CUNMLQ if N>>M)\002)";
    static char fmt_9994[] = "(/\002 CGELSD: overall performance\002,/\002 c"
	    "omp. 1 : if M>>N, CGEQRF, QR factorization\002,/\002            "
	    "        CUNMQR, multiplication by\002,\002 reflectors\002,/\002 "
	    "          if N>>M, CGELQF, QL factorization\002,/\002 comp. 2 : "
	    "CGEBRD, reduction to bidiagonal form\002,/\002 comp. 3 : CUNMBR,"
	    ...
	    "nalizing vectors\002,/\002 comp. 4 : CLALSD, singular value deco"
    ...
    extern /* Subroutine */ int clacpy_(char *, integer *, integer *, complex 
	    *, integer *, complex *, integer *), cgelss_(integer *, 
	    integer *, integer *, complex *, integer *, complex *, integer *, 
	    real *, real *, integer *, complex *, integer *, real *, integer *
	    ), atimin_(char *, char *, integer *, char *, logical *, integer *
	    , integer *, ftnlen, ftnlen, ftnlen), cgelsx_(integer *, integer *
	    , integer *, complex *, integer *, complex *, integer *, integer *
	    , real *, integer *, complex *, real *, integer *), cgelsy_(
	    integer *, integer *, integer *, complex *, integer *, complex *, 
	    integer *, integer *, real *, integer *, complex *, integer *, 
	    real *, integer *), clarnv_(integer *, integer *, integer *, 
	    complex *), slaset_(char *, integer *, integer *, real *, real *, 
	    real *, integer *), xlaenv_(integer *, integer *);
    extern doublereal smflop_(real *, real *, integer *);
    static integer ldwork;
    static logical timsub[5];
    extern /* Subroutine */ int sprtls_(integer *, char *, integer *, integer 
...
/*                          Time CGELS   
				...
				cqrt13_(&iscale, &m, &n, &copya[1], &lda, &
					norma, iseed);
				i__5 = *nnb;
...
/*                                Set up a consistent rhs */
					...
					if (ncols > 0) {
					    i__6 = ncols * nrhs;
					    clarnv_(&c__2, iseed, &i__6, &
						    work[1]);
					    i__6 = ncols * nrhs;
					    r__1 = 1.f / (real) ncols;
					    csscal_(&i__6, &r__1, &work[1], &
						    c__1);
					}
...
L20:
					if (m > 0 && n > 0) {
					    clacpy_("Full", &m, &n, &copya[1],
						     &lda, &a[1], &lda);
					    clacpy_("Full", &nrows, &nrhs, &
						    copyb[1], &ldb, &b[1], &
						    ldb);
					}
					s_copy(srnamc_1.srnamt, "CGELS ", (
						ftnlen)6, (ftnlen)6);
					++ncall;
					s1 = second_();
					cgels_(trans, &m, &n, &nrhs, &a[1], &
						lda, &b[1], &ldb, &work[1], &
						lwork, &info);
					s2 = second_();
					time += s2 - s1;
...
/*                       CGELSX:  Compute the minimum-norm   
				...
				ncall = 0;
				time = 0.f;
				slaset_("Full", &ndata[1], &c__1, &c_b30, &
...
L60:
				clacpy_("Full", &m, &n, &copya[1], &lda, &a[1]
					, &lda);
				clacpy_("Full", &m, &nrhs, &copyb[1], &ldb, &
					b[1], &ldb);
				s_copy(srnamc_1.srnamt, "CGELSX", (ftnlen)6, (
					ftnlen)6);
				++ncall;
				s1 = second_();
				cgelsx_(&m, &n, &nrhs, &a[1], &lda, &b[1], &
...
/*                          Time CGELSY   
   ...
   Computing MAX */
				    ...
				    ncall = 0;
				    time = 0.f;
				    slaset_("Full", &ndata[2], &c__1, &c_b30, 
					    &c_b30, lstime_1.opcnt, &ndata[2]);
				    slaset_("Full", &ndata[2], &c__1, &c_b30, 
					    &c_b30, lstime_1.timng, &ndata[2]);
L80:
				    clacpy_("Full", &m, &n, &copya[1], &lda, &
					    a[1], &lda);
				    clacpy_("Full", &m, &nrhs, &copyb[1], &
					    ldb, &b[1], &ldb);
				    s_copy(srnamc_1.srnamt, "CGELSY", (ftnlen)
					    6, (ftnlen)6);
				    ++ncall;
				    s1 = second_();
				    cgelsy_(&m, &n, &nrhs, &a[1], &lda, &b[1],
...
/*                          Time CGELSS   
				    ...
				    ncall = 0;
				    time = 0.f;
				    slaset_("Full", &ndata[3], &c__1, &c_b30, 
...
L100:
				    ...
				    clacpy_("Full", &m, &nrhs, &copyb[1], &
					    ldb, &b[1], &ldb);
				    s_copy(srnamc_1.srnamt, "CGELSS", (ftnlen)
					    6, (ftnlen)6);
				    ++ncall;
				    s1 = second_();
				    cgelss_(&m, &n, &nrhs, &a[1], &lda, &b[1],
					     &ldb, &s[1], &rcond, &crank, &
...
/*                          Time CGELSD   
				    ...
				    ncall = 0;
				    time = 0.f;
				    slaset_("Full", &ndata[4], &c__1, &c_b30, 
...
L120:
				    ...
				    clacpy_("Full", &m, &nrhs, &copyb[1], &
					    ldb, &b[1], &ldb);
				    s_copy(srnamc_1.srnamt, "CGELSD", (ftnlen)
					    6, (ftnlen)6);
				    ++ncall;
				    s1 = second_();
				    cgelsd_(&m, &n, &nrhs, &a[1], &lda, &b[1],
					     &ldb, &s[1], &rcond, &crank, &
