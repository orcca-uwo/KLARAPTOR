...
/* Subroutine */ int ztimqp_(char *line, integer *nm, integer *mval, integer *
	nval, integer *nlda, integer *ldaval, doublereal *timmin, 
	doublecomplex *a, doublecomplex *copya, doublecomplex *tau, 
	doublecomplex *work, doublereal *rwork, integer *iwork, doublereal *
	reslts, integer *ldr1, integer *ldr2, integer *nout, ftnlen line_len)
{
    /* Initialized data */

    static char subnam[6*1] = "ZGEQPF";
    ...
    extern /* Subroutine */ int atimin_(char *, char *, integer *, char *, 
	    logical *, integer *, integer *, ftnlen, ftnlen, ftnlen), zgeqpf_(
...
L30:
		...
		ops = dopla_("ZGEQPF", &m, &n, &c__0, &c__0, &c__1)
			;
