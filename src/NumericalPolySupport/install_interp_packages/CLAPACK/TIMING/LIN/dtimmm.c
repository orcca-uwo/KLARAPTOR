...
/* Subroutine */ int dtimmm_(char *vname, char *lab2, integer *nn, integer *
	nval, integer *nlda, integer *ldaval, doublereal *timmin, doublereal *
	a, doublereal *b, doublereal *c__, doublereal *reslts, integer *ldr1, 
	integer *ldr2, integer *nout, ftnlen vname_len, ftnlen lab2_len)
{
    /* Initialized data */

    static char subnam[6*1] = "DGEMM ";
    ...
    static integer idummy[1], lda, icl;
...
/*           Time DGEMM */
	    ...
	    dtimmg_(&c__0, &n, &n, &b[1], &lda, &c__0, &c__0);
	    dtimmg_(&c__1, &n, &n, &c__[1], &lda, &c__0, &c__0);
	    ic = 0;
	    s1 = dsecnd_();
L30:
	    dgemm_("No transpose", "No transpose", &n, &n, &n, &c_b27, &a[1], 
