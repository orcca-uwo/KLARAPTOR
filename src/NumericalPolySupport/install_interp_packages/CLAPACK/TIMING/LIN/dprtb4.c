...
/* Subroutine */ int dprtb4_(char *lab1, char *labm, char *labn, integer *nk, 
	integer *kval, integer *lval, integer *nm, integer *mval, integer *
	nval, integer *nlda, doublereal *reslts, integer *ldr1, integer *ldr2,
	 integer *nout, ftnlen lab1_len, ftnlen labm_len, ftnlen labn_len)
{
    /* Format strings */
