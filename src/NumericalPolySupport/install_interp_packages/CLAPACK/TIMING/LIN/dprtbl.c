...
/* Subroutine */ int dprtbl_(char *lab1, char *lab2, integer *nk, integer *
	kval, integer *nn, integer *nval, integer *nlda, doublereal *reslts, 
	integer *ldr1, integer *ldr2, integer *nout, ftnlen lab1_len, ftnlen 
	lab2_len)
{
    /* Format strings */
