...
/* Subroutine */ int stimq3_(char *line, integer *nm, integer *mval, integer *
	nval, integer *nnb, integer *nbval, integer *nxval, integer *nlda, 
	integer *ldaval, real *timmin, real *a, real *copya, real *tau, real *
	work, integer *iwork, real *reslts, integer *ldr1, integer *ldr2, 
	integer *nout, ftnlen line_len)
{
    /* Initialized data */

    static char subnam[6*1] = "SGEQP3";
...
/* L10: */
		    ...
		    s1 = second_();
L20:
		    sgeqp3_(&m, &n, &a[1], &lda, &iwork[1], &tau[1], &work[1],
			     &lw, &info);
		    s2 = second_();
			...
			do_lio(&c__9, &c__1, ">>>Warning: INFO returned by ", 
				(ftnlen)29);
			do_lio(&c__9, &c__1, "SGEQPX is:", (ftnlen)10);
...
/*                 The number of flops of xGEQP3 is approximately the   
		    ...
		    ops = sopla_("SGEQPF", &m, &n, &c__0, &c__0, &nb);
