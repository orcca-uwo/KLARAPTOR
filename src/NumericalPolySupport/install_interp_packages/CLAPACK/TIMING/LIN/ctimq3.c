...
/* Subroutine */ int ctimq3_(char *line, integer *nm, integer *mval, integer *
	nval, integer *nnb, integer *nbval, integer *nxval, integer *nlda, 
	integer *ldaval, real *timmin, complex *a, complex *copya, complex *
	tau, complex *work, real *rwork, integer *iwork, real *reslts, 
	integer *ldr1, integer *ldr2, integer *nout, ftnlen line_len)
{
    /* Initialized data */

    static char subnam[6*1] = "CGEQP3";
    ...
    extern /* Subroutine */ int clacpy_(char *, integer *, integer *, complex 
	    ...
	    *, integer *, char *, logical *, integer *, integer *, ftnlen, 
	    ...
	    char *, complex *, integer *, complex *, integer *), xlaenv_(integer *, integer *);
...
L20:
		    ...
		    cgeqp3_(&m, &n, &a[1], &lda, &iwork[1], &tau[1], &work[1],
			     &lw, &rwork[1], &info);
			...
			do_lio(&c__9, &c__1, ">>>Warning: INFO returned by ", 
				(ftnlen)29);
			do_lio(&c__9, &c__1, "CGEQP3 is:", (ftnlen)10);
...
/*                 The number of flops of yGEQP3 is approximately the   
		    ...
		    ops = sopla_("CGEQPF", &m, &n, &c__0, &c__0, &nb);
		    reslts_ref(inb, im, ilda) = smflop_(&ops, &time, &info);
