...
/* Subroutine */ int dtimls_(char *line, integer *nm, integer *mval, integer *
	nn, integer *nval, integer *nns, integer *nsval, integer *nnb, 
	integer *nbval, integer *nxval, integer *nlda, integer *ldaval, 
	doublereal *timmin, doublereal *a, doublereal *copya, doublereal *b, 
	doublereal *copyb, doublereal *s, doublereal *copys, doublereal *
	opctbl, doublereal *timtbl, doublereal *flptbl, doublereal *work, 
	integer *iwork, integer *nout, ftnlen line_len)
{
    /* Initialized data */

    static char subnam[6*5] = "DGELS " "DGELSX" "DGELSY" "DGELSS" "DGELSD";
    ...
    static char fmt_9999[] = "(///\002 ****** Results for \002,a,\002 *****"
	    "*\002)";
    static char fmt_9998[] = "(/\002 DGELS   : overall performance\002,/\002"
	    " comp. 1 : if M>=N, DGEQRF, QR factorization\002,/\002          "
	    " if M< N, DGELQF, QR factorization\002,/\002 comp. 2 : if M>=N, "
	    "DORMQR, multiplication by\002,\002 reflectors\002,/\002         "
	    "  if M< N, DORMLQ, multiplication by\002,\002 reflectors\002,"
	    "/\002 comp. 3 : DTRSM, solution of the triangular\002,\002 system"
	    "\002,//\002 Types 4 to 6 are the transpose\002,\002 of types 1 t"
	    "o 3\002)";
    static char fmt_9997[] = "(/\002 DGELSX  : overall performance\002,/\002"
	    " comp. 1 : DGEQPF, QR factorization with column\002,\002 pivoting"
	    "\002,/\002 comp. 2 : if RANK<N, DTZRQF, reduction to\002,\002 tr"
	    "iangular form\002,/\002 comp. 3 : DORM2R, multiplication by refl"
	    "ectors\002,/\002 comp. 4 : DTRSM, solution of the triangular\002,"
	    "\002 system\002,/\002 comp. 5 : if RANK<N, DLATZM, multiplicatio"
	    "n by\002,\002 reflectors\002)";
    static char fmt_9996[] = "(/\002 DGELSY  : overall performance\002,/\002"
	    " comp. 1 : DGEQP3, QR factorization with column\002,\002 pivoting"
	    "\002,/\002 comp. 2 : if RANK<N, DTZRZF, reduction to\002,\002 tr"
	    "iangular form\002,/\002 comp. 3 : DORMQR, multiplication by refl"
	    "ectors\002,/\002 comp. 4 : DTRSM, solution of the triangular\002,"
	    "\002 system\002,/\002 comp. 5 : if RANK<N, DORMRZ, multiplicatio"
	    "n by\002,\002 reflectors\002)";
    static char fmt_9995[] = "(/\002 DGELSS: overall performance\002,/\002 c"
	    "omp. 1 : if M>>N, DGEQRF, QR factorization\002,/\002            "
	    "        DORMQR, multiplication by\002,\002 reflectors\002,/\002 "
	    "          if N>>M, DGELQF, QL factorization\002,/\002 comp. 2 : "
	    "DGEBRD, reduction to bidiagonal form\002,/\002 comp. 3 : DORMBR,"
	    " multiplication by left\002,\002 bidiagonalizing vectors\002,"
	    "/\002           DORGBR, generation of right\002,\002 bidiagonali"
	    "zing vectors\002,/\002 comp. 4 : DBDSQR, singular value decompos"
	    "ition\002,\002 of the bidiagonal matrix\002,/\002 comp. 5 : mult"
	    "iplication by right bidiagonalizing\002,\002 vectors\002,/\002  "
	    "         (DGEMM or SGEMV, and DORMLQ if N>>M)\002)";
    static char fmt_9994[] = "(/\002 DGELSD: overall performance\002,/\002 c"
	    "omp. 1 : if M>>N, DGEQRF, QR factorization\002,/\002            "
	    "        DORMQR, multiplication by\002,\002 reflectors\002,/\002 "
	    "          if N>>M, DGELQF, QL factorization\002,/\002 comp. 2 : "
	    "DGEBRD, reduction to bidiagonal form\002,/\002 comp. 3 : DORMBR,"
	    ...
	    "nalizing vectors\002,/\002 comp. 4 : DLALSD, singular value deco"
    ...
    static integer ncls, isub, nrhs, nlvl, i__, m, n;
    ...
    extern /* Subroutine */ int dcopy_(integer *, doublereal *, integer *, 
	    doublereal *, integer *), dqrt13_(integer *, integer *, integer *,
	     doublereal *, integer *, doublereal *, integer *), dqrt15_(
    ...
    extern /* Subroutine */ int atimin_(char *, char *, integer *, char *, 
	    logical *, integer *, integer *, ftnlen, ftnlen, ftnlen), dgelss_(
	    integer *, integer *, integer *, doublereal *, integer *, 
	    doublereal *, integer *, doublereal *, doublereal *, integer *, 
	    doublereal *, integer *, integer *), dgelsx_(integer *, integer *,
	     integer *, doublereal *, integer *, doublereal *, integer *, 
	    integer *, doublereal *, integer *, doublereal *, integer *), 
	    dgelsy_(integer *, integer *, integer *, doublereal *, integer *, 
	    doublereal *, integer *, integer *, doublereal *, integer *, 
	    doublereal *, integer *, integer *), dlarnv_(integer *, integer *,
	     integer *, doublereal *), xlaenv_(integer *, integer *);
    static integer ldwork;
    static logical timsub[5];
    extern /* Subroutine */ int dprtls_(integer *, char *, integer *, integer 
...
/*                          Time DGELS   
				...
				dqrt13_(&iscale, &m, &n, &copya[1], &lda, &
					norma, iseed);
				i__5 = *nnb;
...
/*                                Set up a consistent rhs */
					...
					if (ncols > 0) {
					    i__6 = ncols * nrhs;
					    dlarnv_(&c__2, iseed, &i__6, &
						    work[1]);
					    i__6 = ncols * nrhs;
					    d__1 = 1. / (doublereal) ncols;
					    dscal_(&i__6, &d__1, &work[1], &
						    c__1);
					}
...
L20:
					if (m > 0 && n > 0) {
					    dlacpy_("Full", &m, &n, &copya[1],
						     &lda, &a[1], &lda);
					    dlacpy_("Full", &nrows, &nrhs, &
						    copyb[1], &ldb, &b[1], &
						    ldb);
					}
					s_copy(srnamc_1.srnamt, "DGELS ", (
						ftnlen)6, (ftnlen)6);
					++ncall;
					s1 = dsecnd_();
					dgels_(trans, &m, &n, &nrhs, &a[1], &
						lda, &b[1], &ldb, &work[1], &
						lwork, &info);
					s2 = dsecnd_();
					time += s2 - s1;
...
/*                       DGELSX:  Compute the minimum-norm   
				...
				ncall = 0;
				time = 0.;
				dlaset_("Full", &ndata[1], &c__1, &c_b28, &
...
L60:
				dlacpy_("Full", &m, &n, &copya[1], &lda, &a[1]
					, &lda);
				dlacpy_("Full", &m, &nrhs, &copyb[1], &ldb, &
					b[1], &ldb);
				s_copy(srnamc_1.srnamt, "DGELSX", (ftnlen)6, (
					ftnlen)6);
				++ncall;
				s1 = dsecnd_();
				dgelsx_(&m, &n, &nrhs, &a[1], &lda, &b[1], &
...
/*                          Time DGELSY   
   ...
   Computing MAX */
				    ...
				    ncall = 0;
				    time = 0.;
				    dlaset_("Full", &ndata[2], &c__1, &c_b28, 
					    &c_b28, lstime_1.opcnt, &ndata[2]);
				    dlaset_("Full", &ndata[2], &c__1, &c_b28, 
					    &c_b28, lstime_1.timng, &ndata[2]);
L80:
				    dlacpy_("Full", &m, &n, &copya[1], &lda, &
					    a[1], &lda);
				    dlacpy_("Full", &m, &nrhs, &copyb[1], &
					    ldb, &b[1], &ldb);
				    s_copy(srnamc_1.srnamt, "DGELSY", (ftnlen)
					    6, (ftnlen)6);
				    ++ncall;
				    s1 = dsecnd_();
				    dgelsy_(&m, &n, &nrhs, &a[1], &lda, &b[1],
...
/*                          Time DGELSS   
				    ...
				    ncall = 0;
				    time = 0.;
				    dlaset_("Full", &ndata[3], &c__1, &c_b28, 
...
L100:
				    ...
				    dlacpy_("Full", &m, &nrhs, &copyb[1], &
					    ldb, &b[1], &ldb);
				    s_copy(srnamc_1.srnamt, "DGELSS", (ftnlen)
					    6, (ftnlen)6);
				    ++ncall;
				    s1 = dsecnd_();
				    dgelss_(&m, &n, &nrhs, &a[1], &lda, &b[1],
					     &ldb, &s[1], &rcond, &crank, &
					    work[1], &lwork, &info);
				    s2 = dsecnd_();
				    time += s2 - s1;
...
/*                          Time DGELSD   
				    ...
				    ncall = 0;
				    time = 0.;
				    dlaset_("Full", &ndata[4], &c__1, &c_b28, 
...
L120:
				    ...
				    dlacpy_("Full", &m, &nrhs, &copyb[1], &
					    ldb, &b[1], &ldb);
				    s_copy(srnamc_1.srnamt, "DGELSD", (ftnlen)
					    6, (ftnlen)6);
				    ++ncall;
				    s1 = dsecnd_();
				    dgelsd_(&m, &n, &nrhs, &a[1], &lda, &b[1],
					     &ldb, &s[1], &rcond, &crank, &
