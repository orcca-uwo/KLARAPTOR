...
/* Subroutine */ int dtimge_(char *line, integer *nm, integer *mval, integer *
	...
	integer *ldr2, integer *ldr3, integer *nout, ftnlen line_len)
{
    ...
    static char subnam[6*3] = "DGETRF" "DGETRS" "DGETRI";
    ...
    extern /* Subroutine */ int atimck_(integer *, char *, integer *, integer 
	    *, integer *, integer *, integer *, integer *, ftnlen), dgetrf_(
	    integer *, integer *, doublereal *, integer *, integer *, integer 
	    *), dlacpy_(char *, integer *, integer *, doublereal *, integer *,
	     doublereal *, integer *), dgetri_(integer *, doublereal *
    ...
    extern /* Subroutine */ int atimin_(char *, char *, integer *, char *, 
	    ...
	    *, integer *), dprtbl_(char *, char *, integer *, integer *, 
	    integer *, integer *, integer *, doublereal *, integer *, integer 
	    *, integer *, ftnlen, ftnlen), dgetrs_(char *, integer *, integer 
...
/*              Time DGETRF */
		...
		if (timsub[0]) {
		    ...
		    s1 = dsecnd_();
L10:
		    dgetrf_(&m, &n, &a[1], &lda, &iwork[1], &info);
		    s2 = dsecnd_();
		    time = s2 - s1;
		    ++ic;
		    if (time < *timmin) {
...
L20:
		    ...
		    ops = dopla_("DGETRF", &m, &n, &c__0, &c__0, &nb);
...
L30:
		    i__4 = lda * nb;
		    dgetri_(&m, &b[1], &lda, &iwork[1], &work[1], &i__4, &
			    info);
		    s2 = dsecnd_();
		    time = s2 - s1;
		    ++ic;
...
L40:
		    ...
		    time = (time - untime) / (doublereal) ic;
		    ops = dopla_("DGETRI", &m, &m, &c__0, &c__0, &nb);
...
/*           Time DGETRS */
		...
		for (i__ = 1; i__ <= i__3; ++i__) {
		    ...
		    s1 = dsecnd_();
L60:
		    dgetrs_("No transpose", &m, &nrhs, &a[1], &lda, &iwork[1],
			     &b[1], &ldb, &info);
		    s2 = dsecnd_();
		    time = s2 - s1;
		    ++ic;
...
L70:
		    ...
		    time = (time - untime) / (doublereal) ic;
		    ops = dopla_("DGETRS", &m, &nrhs, &c__0, &c__0, &c__0);
