...
/* Subroutine */ int dtimq3_(char *line, integer *nm, integer *mval, integer *
	nval, integer *nnb, integer *nbval, integer *nxval, integer *nlda, 
	integer *ldaval, doublereal *timmin, doublereal *a, doublereal *copya,
	 doublereal *tau, doublereal *work, integer *iwork, doublereal *
	reslts, integer *ldr1, integer *ldr2, integer *nout, ftnlen line_len)
{
    /* Initialized data */

    static char subnam[6*1] = "DGEQP3";
    ...
    extern /* Subroutine */ int dgeqp3_(integer *, integer *, doublereal *, 
	    ...
	    integer *), dprtb4_(char *, char *, char *, integer *, integer *, 
...
/* L10: */
		    ...
		    s1 = dsecnd_();
L20:
		    dgeqp3_(&m, &n, &a[1], &lda, &iwork[1], &tau[1], &work[1],
			     &lw, &info);
		    s2 = dsecnd_();
			...
			do_lio(&c__9, &c__1, ">>>Warning: INFO returned by ", 
				(ftnlen)29);
			do_lio(&c__9, &c__1, "DGEQPX is:", (ftnlen)10);
...
/*                 The number of flops of xGEQP3 is approximately the   
		    ...
		    ops = dopla_("DGEQPF", &m, &n, &c__0, &c__0, &nb);
