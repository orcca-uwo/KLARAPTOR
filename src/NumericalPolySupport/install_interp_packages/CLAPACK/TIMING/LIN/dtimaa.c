...
struct {
    integer nb, nproc, nshift, neispk;
} cenvir_;
...
/* Main program */ MAIN__(void)
{
    ...
    static doublereal work[280576]	/* was [512][548] */, a[1089536]	
	    /* was [272384][4] */, d__[2048]	/* was [1024][2] */;
    ...
    extern /* Subroutine */ int dtimb2_(char *, integer *, integer *, integer 
	    *, integer *, integer *, integer *, integer *, integer *, integer 
	    *, integer *, integer *, doublereal *, doublereal *, doublereal *,
	     doublereal *, doublereal *, integer *, integer *, integer *, 
	    ftnlen), dtimb3_(char *, integer *, integer *, integer *, integer 
	    *, integer *, integer *, integer *, integer *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, integer *,
	     integer *, integer *, ftnlen), dtimq3_(char *, integer *, 
	    integer *, integer *, integer *, integer *, integer *, integer *, 
    ...
    extern /* Subroutine */ int dtimgb_(char *, integer *, integer *, integer 
	    *, integer *, integer *, integer *, integer *, integer *, integer 
	    *, integer *, doublereal *, doublereal *, doublereal *, integer *,
	     doublereal *, integer *, integer *, integer *, integer *, ftnlen)
	    , dtimge_(char *, integer *, integer *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, integer *, doublereal *,
	     integer *, integer *, integer *, integer *, ftnlen);
    extern logical lsamen_(integer *, char *, char *);
    extern /* Subroutine */ int dtimpb_(char *, integer *, integer *, integer 
	    *, integer *, integer *, integer *, integer *, integer *, integer 
	    *, integer *, doublereal *, doublereal *, doublereal *, integer *,
	     doublereal *, integer *, integer *, integer *, integer *, ftnlen)
	    , dtimbr_(char *, integer *, integer *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, integer *, integer *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, integer *, integer *, 
	    integer *, integer *, ftnlen);
    static doublereal flptbl[1088640], opctbl[1088640];
    extern /* Subroutine */ int dtimtb_(char *, integer *, integer *, integer 
	    *, integer *, integer *, integer *, integer *, integer *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, integer *,
	     integer *, integer *, integer *, ftnlen), dtimhr_(char *, 
	    integer *, integer *, integer *, integer *, integer *, integer *, 
	    integer *, integer *, integer *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, integer *,
	     integer *, integer *, integer *, ftnlen), dtimgt_(char *, 
	    integer *, integer *, integer *, integer *, integer *, integer *, 
	    doublereal *, doublereal *, doublereal *, integer *, doublereal *,
	     integer *, integer *, integer *, integer *, ftnlen), dtimlq_(
	    char *, integer *, integer *, integer *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, integer *, doublereal 
	    *, doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, integer *, integer *, integer *, integer *, ftnlen);
    static doublereal timtbl[1088640];
    extern /* Subroutine */ int dtimls_(char *, integer *, integer *, integer 
	    *, integer *, integer *, integer *, integer *, integer *, integer 
	    *, integer *, integer *, doublereal *, doublereal *, doublereal *,
	     doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, integer *,
    ...
    extern /* Subroutine */ int dtimmm_(char *, char *, integer *, integer *, 
	    integer *, integer *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, integer *, integer *, integer *, 
	    ftnlen, ftnlen);
    static logical nxnbok;
    extern /* Subroutine */ int dtimmv_(char *, integer *, integer *, integer 
	    *, integer *, integer *, integer *, doublereal *, doublereal *, 
	    integer *, doublereal *, doublereal *, doublereal *, integer *, 
	    integer *, integer *, ftnlen), dtimpo_(char *, integer *, integer 
	    *, integer *, integer *, integer *, integer *, integer *, integer 
	    *, doublereal *, doublereal *, doublereal *, integer *, 
	    doublereal *, integer *, integer *, integer *, integer *, ftnlen),
	     dtimpp_(char *, integer *, integer *, integer *, integer *, 
	    integer *, doublereal *, doublereal *, doublereal *, integer *, 
	    doublereal *, integer *, integer *, integer *, integer *, ftnlen),
	     dtimpt_(char *, integer *, integer *, integer *, integer *, 
	    integer *, integer *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, integer *, integer *, integer *, integer *, ftnlen),
	     dtimql_(char *, integer *, integer *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, integer *, integer *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, integer *, integer *, integer *, 
	    integer *, ftnlen), dtimqp_(char *, integer *, integer *, integer 
	    *, integer *, integer *, doublereal *, doublereal *, doublereal *,
	     doublereal *, doublereal *, integer *, doublereal *, integer *, 
	    integer *, integer *, ftnlen), dtimqr_(char *, integer *, integer 
	    *, integer *, integer *, integer *, integer *, integer *, integer 
	    *, integer *, integer *, doublereal *, doublereal *, doublereal *,
	     doublereal *, doublereal *, doublereal *, integer *, integer *, 
	    integer *, integer *, ftnlen), dtimrq_(char *, integer *, integer 
	    *, integer *, integer *, integer *, integer *, integer *, integer 
	    *, integer *, integer *, doublereal *, doublereal *, doublereal *,
	     doublereal *, doublereal *, doublereal *, integer *, integer *, 
	    integer *, integer *, ftnlen), dtimsp_(char *, integer *, integer 
	    *, integer *, integer *, integer *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, integer *, doublereal *, integer *, 
	    integer *, integer *, integer *, ftnlen), dtimsy_(char *, integer 
	    *, integer *, integer *, integer *, integer *, integer *, integer 
	    *, integer *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, integer *, doublereal *, integer *, integer *, 
	    integer *, integer *, ftnlen), dtimtd_(char *, integer *, integer 
	    *, integer *, integer *, integer *, integer *, integer *, integer 
	    *, integer *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, integer *,
	     integer *, integer *, integer *, ftnlen);
    static doublereal reslts[6912]	/* was [6][6][8][24] */;
    extern /* Subroutine */ int dtimtp_(char *, integer *, integer *, integer 
	    *, integer *, integer *, doublereal *, doublereal *, doublereal *,
	     doublereal *, integer *, integer *, integer *, integer *, ftnlen)
	    , dtimtr_(char *, integer *, integer *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, integer *, integer *, 
	    integer *, integer *, ftnlen);
    static integer nnb;
    ...
    static cilist io___100 = { 0, 6, 0, fmt_9987, 0 };
    static cilist io___101 = { 0, 5, 1, "(A)", 0 };
    static cilist io___103 = { 0, 6, 0, fmt_9986, 0 };
    static cilist io___104 = { 0, 6, 0, fmt_9985, 0 };
...
/*        If the first record is the special signal 'BAND', then time   
	...
	if (lsamen_(&c__4, line, "BAND")) {
		...
		i__1 = mkmax / 2;
		dtimmv_("DGBMV ", &nm, mval, &nn, nval, &nlda, ldaval, &
			timmin, &a_ref(1, 1), &i__1, &a_ref(i2, j2), &a_ref(
			272384 - mkmax / 2 + 1, 3), reslts, &ldr1, &ldr2, &
			c__6, (ftnlen)6);
	    } else {
		s_wsfe(&io___83);
		do_fio(&c__1, "DGBMV ", (ftnlen)6);
		e_wsfe();
	    }
	    dtimmm_("DGEMM ", "K", &nn, nval, &nlda, ldaval, &timmin, &a_ref(
...
/*           Otherwise time DGEMV and SGEMM. */
	    ...
	    dtimmv_("DGEMV ", &nn, nval, &nnb, nbval, &nlda, ldaval, &timmin, 
		    &a_ref(1, 1), &c_b172, &a_ref(1, 2), &a_ref(1, 3), reslts,
		     &ldr1, &ldr2, &c__6, (ftnlen)6);
	    dtimmm_("DGEMM ", "N", &nn, nval, &nlda, ldaval, &timmin, &a_ref(
		    1, 1), &a_ref(1, 2), &a_ref(1, 3), reslts, &ldr1, &ldr2, &
		    c__6, (ftnlen)6, (ftnlen)1);
	}
    }
...
/*        Level 2 BLAS */
	...
	dtimb2_(line, &nm, mval, &nn, nval, &nk, kval, &nnb, nbval, &nlda, 
...
/*        Level 3 BLAS */
	...
	dtimb3_(line, &nm, mval, &nn, nval, &nk, kval, &nlda, ldaval, &timmin,
...
/*        QR routines */
	...
	dtimqr_(line, &nn, mval, nval, &nk, kval, &nnb, nbval, nxval, &nlda, 
...
/*        LQ routines */
	...
	dtimlq_(line, &nn, mval, nval, &nk, kval, &nnb, nbval, nxval, &nlda, 
		ldaval, &timmin, &a_ref(1, 1), d__, &a_ref(1, 2), &a_ref(1, 3)
		, reslts, &ldr1, &ldr2, &ldr3, &c__6, (ftnlen)80);
...
/*        QL routines */
	...
	dtimql_(line, &nn, mval, nval, &nk, kval, &nnb, nbval, nxval, &nlda, 
		ldaval, &timmin, &a_ref(1, 1), d__, &a_ref(1, 2), &a_ref(1, 3)
		, reslts, &ldr1, &ldr2, &ldr3, &c__6, (ftnlen)80);
...
/*        RQ routines */
	...
	dtimrq_(line, &nn, mval, nval, &nk, kval, &nnb, nbval, nxval, &nlda, 
		ldaval, &timmin, &a_ref(1, 1), d__, &a_ref(1, 2), &a_ref(1, 3)
		, reslts, &ldr1, &ldr2, &ldr3, &c__6, (ftnlen)80);
...
/*        QR with column pivoting */
	...
	dtimqp_(line, &nm, mval, nval, &nlda, ldaval, &timmin, &a_ref(1, 1), &
		a_ref(1, 2), &d___ref(1, 1), &a_ref(1, 3), iwork, reslts, &
		ldr1, &ldr2, &c__6, (ftnlen)80);

/*        Blas-3 QR with column pivoting */

	dtimq3_(line, &nm, mval, nval, &nnb, nbval, nxval, &nlda, ldaval, &
...
/*        Reduction to Hessenberg form */
	...
	dtimhr_(line, &nn, nval, &nk, kval, &nnb, nbval, nxval, &nlda, ldaval,
...
/*        Reduction to tridiagonal form */
	...
	dtimtd_(line, &nn, nval, &nk, kval, &nnb, nbval, nxval, &nlda, ldaval,
...
/*        Reduction to bidiagonal form */
	...
	dtimbr_(line, &nn, mval, nval, &nk, kval, &nnb, nbval, nxval, &nlda, 
...
/*        Routines for general matrices */
	...
	dtimge_(line, &nn, nval, &nk, kval, &nnb, nbval, &nlda, ldaval, &
...
/*        General band matrices */
	...
	if (ldamok) {
	    dtimgb_(line, &nm, mval, &nn, nval, &nk, kval, &nnb, nbval, &nlda,
...
/*        Routines for general tridiagonal matrices */
	...
	dtimgt_(line, &nn, nval, &nk, kval, &nlda, ldaval, &timmin, &a_ref(1, 
...
/*        Positive definite matrices */
	...
	dtimpo_(line, &nn, nval, &nk, kval, &nnb, nbval, &nlda, ldaval, &
...
/*        Positive definite packed matrices */
	...
	dtimpp_(line, &nn, nval, &nk, kval, &c_b172, &timmin, &a_ref(1, 1), &
...
/*        Positive definite banded matrices */
	...
	if (ldamok) {
	    ...
	    dtimpb_(line, &nm, mval, &nn, nval, &nk, kval, &nnb, nbval, &nlda,
...
/*        Routines for positive definite tridiagonal matrices */
	...
	dtimpt_(line, &nn, nval, &nk, kval, &nlda, ldaval, &timmin, &a_ref(1, 
...
/*        Symmetric indefinite matrices */
	...
	dtimsy_(line, &nn, nval, &nk, kval, &nnb, nbval, &nlda, ldaval, &
		timmin, &a_ref(1, 1), &a_ref(1, 2), &a_ref(1, 3), iwork, 
		reslts, &ldr1, &ldr2, &ldr3, &c__6, (ftnlen)80);
...
/*        Symmetric indefinite packed matrices */
	...
	dtimsp_(line, &nn, nval, &nk, kval, &c_b172, &timmin, &a_ref(1, 1), &
...
/*        Triangular matrices */
	...
	dtimtr_(line, &nn, nval, &nk, kval, &nnb, nbval, &nlda, ldaval, &
...
/*        Triangular packed matrices */
	...
	dtimtp_(line, &nn, nval, &nk, kval, &c_b172, &timmin, &a_ref(1, 1), &
...
/*        Triangular band matrices */
	...
	if (ldamok) {
	    ...
	    dtimtb_(line, &nm, mval, &nn, nval, &nk, kval, &nlda, ldaval, &
...
/*        Least squares drivers */
	...
	dtimls_(line, &nm, mval, &nn, nval, &nk, kval, &nnb, nbval, nxval, &
		nlda, ldaval, &timmin, &a_ref(1, 1), &a_ref(1, 2), &a_ref(1, 
		3), &a_ref(1, 4), s, &s[512], opctbl, timtbl, flptbl, work, 
...
/* Main program alias */ int dtimaa_ () { MAIN__ (); return 0; }
