...
/* Subroutine */ int stimpp_(char *line, integer *nn, integer *nval, integer *
	...
	ldr3, integer *nout, ftnlen line_len)
{
    ...
    static char subnam[6*3] = "SPPTRF" "SPPTRS" "SPPTRI";
    ...
    extern /* Subroutine */ int sprtbl_(char *, char *, integer *, integer *, 
	    ...
	    integer *), spptri_(char *, integer *, real *, integer *), spptrs_(char *, integer *, integer *, real *, real *, 
	    integer *, integer *);
...
L20:
		...
		ops = sopla_("SPPTRF", &n, &n, &c__0, &c__0, &c__0)
			;
...
L40:
		...
		time = (time - untime) / (real) ic;
		ops = sopla_("SPPTRI", &n, &n, &c__0, &c__0, &c__0)
			;
...
/*           Time SPPTRS */
		...
		for (i__ = 1; i__ <= i__2; ++i__) {
		    ...
		    s1 = second_();
L50:
		    spptrs_(uplo, &n, &nrhs, &a[1], &b[1], &ldb, &info);
		    s2 = second_();
		    time = s2 - s1;
		    ++ic;
		    if (time < *timmin) {
...
L60:
		    ...
		    time = (time - untime) / (real) ic;
		    ops = sopla_("SPPTRS", &n, &nrhs, &c__0, &c__0, &c__0);
