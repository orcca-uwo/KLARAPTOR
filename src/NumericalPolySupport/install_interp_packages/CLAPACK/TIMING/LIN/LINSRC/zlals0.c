...
/*        Apply back orthogonal transformations from the left.   
	...
	latime_1.ops += (doublereal) (*nrhs * 12 * *givptr);
	i__1 = *givptr;
...
/* L60: */
		...
		dgemv_("T", k, nrhs, &c_b16, &rwork[*k + 1 + (*nrhs << 1)], k,
...
/* L90: */
		...
		latime_1.ops += (doublereal) (*nrhs * 6);
		zlascl_("G", &c__0, &c__0, &temp, &c_b16, &c__1, nrhs, &b_ref(
			j, 1), ldb, info);
/* L100: */
	    }
	}
...
/*        Step (2R): if SQRE = 1, apply back the rotation that is   
	...
	if (*sqre == 1) {
	    latime_1.ops += (doublereal) (*nrhs * 12);
