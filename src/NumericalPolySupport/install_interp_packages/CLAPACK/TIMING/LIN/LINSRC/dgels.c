	...
	doublereal *work, integer *lwork, integer *info)
{
    ...
    static doublereal rwork[1], t1, t2;
...
/*        Scale matrix norm up to SMLNUM */
	...
	lstime_1.opcnt[gels - 1] += (doublereal) (*m * *n);
...
/*        Scale matrix norm up to SMLNUM */
	...
	lstime_1.opcnt[gels - 1] += (doublereal) (brow * *nrhs);
...
/*        compute QR factorization of A */
	...
	nb = ilaenv_(&c__1, "DGEQRF", " ", m, n, &c_n1, &c_n1, (ftnlen)6, (
		ftnlen)1);
	lstime_1.opcnt[geqrf - 1] += dopla_("DGEQRF", m, n, &c__0, &c__0, &nb);
	t1 = dsecnd_();
	i__1 = *lwork - mn;
...
/*           workspace at least NRHS, optimally NRHS*NB   
	    ...
	    lstime_1.opcnt[trsm - 1] += dopbl3_("DTRSM ", n, nrhs, &c__0);
	    t1 = dsecnd_();
	    dtrsm_("Left", "Upper", "No transpose", "Non-unit", n, nrhs, &
		    c_b77, &a[a_offset], lda, &b[b_offset], ldb);
	    t2 = dsecnd_();
...
/*           Overdetermined system of equations A' * X = B   
	    ...
	    lstime_1.opcnt[trsm - 1] += dopbl3_("DTRSM ", n, nrhs, &c__0);
	    t1 = dsecnd_();
	    dtrsm_("Left", "Upper", "Transpose", "Non-unit", n, nrhs, &c_b77, 
...
/*           B(1:M,1:NRHS) := Q(1:N,:) * B(1:N,1:NRHS) */
	    ...
	    nb = ilaenv_(&c__1, "DORMQR", "LN", m, nrhs, n, &c_n1, (ftnlen)6, 
		    (ftnlen)2);
	    lstime_1.opcnt[ormqr - 1] += dopla_("DORMQR", m, nrhs, n, &c__0, &
		    nb);
	    t1 = dsecnd_();
...
/*        Compute LQ factorization of A */
	...
	nb = ilaenv_(&c__1, "DGELQF", " ", m, n, &c_n1, &c_n1, (ftnlen)6, (
		ftnlen)1);
	lstime_1.opcnt[gelqf - 1] += dopla_("DGELQF", m, n, &c__0, &c__0, &nb);
	t1 = dsecnd_();
	i__1 = *lwork - mn;
...
/*           underdetermined system of equations A * X = B   
	    ...
	    lstime_1.opcnt[trsm - 1] += dopbl3_("DTRSM ", m, nrhs, &c__0);
	    t1 = dsecnd_();
...
/*           overdetermined system min || A' * X - B ||   
	    ...
	    nb = ilaenv_(&c__1, "DORMLQ", "LN", n, nrhs, m, &c_n1, (ftnlen)6, 
		    (ftnlen)2);
	    lstime_1.opcnt[ormlq - 1] += dopla_("DORMLQ", n, nrhs, m, &c__0, &
		    nb);
	    t1 = dsecnd_();
...
/*           workspace at least NRHS, optimally NRHS*NB   
	    ...
	    lstime_1.opcnt[trsm - 1] += dopbl3_("DTRSM ", m, nrhs, &c__0);
	    t1 = dsecnd_();
	    dtrsm_("Left", "Lower", "Transpose", "Non-unit", m, nrhs, &c_b77, 
		    &a[a_offset], lda, &b[b_offset], ldb);
	    t2 = dsecnd_();
	    lstime_1.timng[trsm - 1] += t2 - t1;
...
/*     Undo scaling */
    ...
    if (iascl == 1) {
	lstime_1.opcnt[gels - 1] += (doublereal) (scllen * *nrhs);
