	...
	k, doublereal *c__, doublereal *s, doublereal *work, integer *info)
{
    ...
    extern doublereal dlamc3_(doublereal *, doublereal *), dopbl2_(char *, 
...
/*        Apply back orthogonal transformations from the left.   
	...
	latime_1.ops += (doublereal) (*nrhs * 6 * *givptr);
	i__1 = *givptr;
...
/* L40: */
		...
		work[1] = -1.;
		latime_1.ops = latime_1.ops + (*k << 1) + *nrhs + dopbl2_(
			"DGEMV ", k, nrhs, &c__0, &c__0);
		temp = dnrm2_(k, &work[1], &c__1);
		dgemv_("T", k, nrhs, &c_b14, &bx[bx_offset], ldbx, &work[1], &
			c__1, &c_b16, &b_ref(j, 1), ldb);
		dlascl_("G", &c__0, &c__0, &temp, &c_b14, &c__1, nrhs, &b_ref(
			j, 1), ldb, info);
/* L50: */
	    }
	}
...
/* L70: */
		...
		latime_1.ops += dopbl2_("DGEMV ", k, nrhs, &c__0, &c__0);
		dgemv_("T", k, nrhs, &c_b14, &b[b_offset], ldb, &work[1], &
			c__1, &c_b16, &bx_ref(j, 1), ldbx);
/* L80: */
	    }
	}
