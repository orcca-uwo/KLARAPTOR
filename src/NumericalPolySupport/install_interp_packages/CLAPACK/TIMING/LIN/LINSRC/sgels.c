...
/*        Scale matrix norm up to SMLNUM */
	...
	lstime_1.opcnt[gels - 1] += (real) (*m * *n);
...
/*        Scale matrix norm up to SMLNUM */
	...
	lstime_1.opcnt[gels - 1] += (real) (brow * *nrhs);
...
/*        compute QR factorization of A */
	...
	nb = ilaenv_(&c__1, "SGEQRF", " ", m, n, &c_n1, &c_n1, (ftnlen)6, (
		ftnlen)1);
	lstime_1.opcnt[geqrf - 1] += sopla_("SGEQRF", m, n, &c__0, &c__0, &nb);
	t1 = second_();
	i__1 = *lwork - mn;
...
/*           workspace at least NRHS, optimally NRHS*NB   
	    ...
	    lstime_1.opcnt[trsm - 1] += sopbl3_("STRSM ", n, nrhs, &c__0);
	    t1 = second_();
...
/*           Overdetermined system of equations A' * X = B   
	    ...
	    lstime_1.opcnt[trsm - 1] += sopbl3_("STRSM ", n, nrhs, &c__0);
	    t1 = second_();
	    strsm_("Left", "Upper", "Transpose", "Non-unit", n, nrhs, &c_b77, 
...
/*           B(1:M,1:NRHS) := Q(1:N,:) * B(1:N,1:NRHS) */
	    ...
	    nb = ilaenv_(&c__1, "SORMQR", "LN", m, nrhs, n, &c_n1, (ftnlen)6, 
		    (ftnlen)2);
	    lstime_1.opcnt[ormqr - 1] += sopla_("SORMQR", m, nrhs, n, &c__0, &
		    nb);
	    t1 = second_();
...
/*        Compute LQ factorization of A */
	...
	nb = ilaenv_(&c__1, "SGELQF", " ", m, n, &c_n1, &c_n1, (ftnlen)6, (
		ftnlen)1);
	lstime_1.opcnt[gelqf - 1] += sopla_("SGELQF", m, n, &c__0, &c__0, &nb);
	t1 = second_();
	i__1 = *lwork - mn;
...
/*           underdetermined system of equations A * X = B   
	    ...
	    lstime_1.opcnt[trsm - 1] += sopbl3_("STRSM ", m, nrhs, &c__0);
	    t1 = second_();
...
/*           overdetermined system min || A' * X - B ||   
	    ...
	    nb = ilaenv_(&c__1, "SORMLQ", "LN", n, nrhs, m, &c_n1, (ftnlen)6, 
		    (ftnlen)2);
	    lstime_1.opcnt[ormlq - 1] += sopla_("SORMLQ", n, nrhs, m, &c__0, &
		    nb);
	    t1 = second_();
...
/*           workspace at least NRHS, optimally NRHS*NB   
	    ...
	    lstime_1.opcnt[trsm - 1] += sopbl3_("STRSM ", m, nrhs, &c__0);
	    t1 = second_();
	    strsm_("Left", "Lower", "Transpose", "Non-unit", m, nrhs, &c_b77, 
		    &a[a_offset], lda, &b[b_offset], ldb);
	    t2 = second_();
	    lstime_1.timng[trsm - 1] += t2 - t1;
...
/*     Undo scaling */
    ...
    if (iascl == 1) {
	lstime_1.opcnt[gels - 1] += (real) (scllen * *nrhs);
