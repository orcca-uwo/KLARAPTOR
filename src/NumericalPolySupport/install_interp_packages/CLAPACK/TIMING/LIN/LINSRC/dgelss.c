...
/*        Scale matrix norm up to SMLNUM */
	...
	lstime_1.opcnt[gelss - 1] += (doublereal) (*m * *n);
...
/*        Scale matrix norm up to SMLNUM */
	...
	lstime_1.opcnt[gelss - 1] += (doublereal) (*m * *nrhs);
...
/*           Compute A=Q*R   
	    ...
	    nb = ilaenv_(&c__1, "DGEQRF", " ", m, n, &c_n1, &c_n1, (ftnlen)6, 
		    (ftnlen)1);
	    lstime_1.opcnt[geqrf - 1] += dopla_("DGEQRF", m, n, &c__0, &c__0, 
		    &nb);
	    t1 = dsecnd_();
	    i__1 = *lwork - iwork + 1;
...
/*           Multiply B by transpose(Q)   
	    ...
	    nb = ilaenv_(&c__1, "DORMQR", "LT", m, nrhs, n, &c_n1, (ftnlen)6, 
		    (ftnlen)2);
	    lstime_1.opcnt[ormqr - 1] += dopla_("DORMQR", m, nrhs, n, &c__0, &
		    nb);
	    t1 = dsecnd_();
	    i__1 = *lwork - iwork + 1;
...
/*        Bidiagonalize R in A   
	...
	nb = ilaenv_(&c__1, "DGEBRD", " ", &mm, n, &c_n1, &c_n1, (ftnlen)6, (
		ftnlen)1);
	lstime_1.opcnt[gebrd - 1] += dopla_("DGEBRD", &mm, n, &c__0, &c__0, &
		nb);
	t1 = dsecnd_();
	i__1 = *lwork - iwork + 1;
...
/*        Multiply B by transpose of left bidiagonalizing vectors of R   
	...
	nb = ilaenv_(&c__1, "DORMBR", "QLT", &mm, nrhs, n, &c_n1, (ftnlen)6, (
		ftnlen)3);
	lstime_1.opcnt[ormbr - 1] += dopla2_("DORMBR", "QLT", &mm, nrhs, n, &
		c__0, &nb);
	t1 = dsecnd_();
	i__1 = *lwork - iwork + 1;
...
/*        Generate right bidiagonalizing vectors of R in A   
	...
	nb = ilaenv_(&c__1, "DORGBR", "P", n, n, n, &c_n1, (ftnlen)6, (ftnlen)
		1);
	lstime_1.opcnt[orgbr - 1] += dopla2_("DORGBR", "P", n, n, n, &c__0, &
		nb);
	t1 = dsecnd_();
	i__1 = *lwork - iwork + 1;
...
/*        Multiply B by right singular vectors   
	...
	if (*lwork >= *ldb * *nrhs && *nrhs > 1) {
	    lstime_1.opcnt[gemm - 1] += dopbl3_("DGEMM ", n, nrhs, n);
	    t1 = dsecnd_();
	    dgemm_("T", "N", n, nrhs, n, &c_b145, &a[a_offset], lda, &b[
...
/* Computing MIN */
		i__3 = *nrhs - i__ + 1;
		bl = min(i__3,chunk);
		lstime_1.opcnt[gemm - 1] += dopbl3_("DGEMM ", n, &bl, n);
		t1 = dsecnd_();
		dgemm_("T", "N", n, &bl, n, &c_b145, &a[a_offset], lda, &
...
/* L20: */
	    ...
	    lstime_1.opcnt[gemv - 1] += dopbl2_("DGEMV ", n, n, &c__0, &c__0);
	    t1 = dsecnd_();
	    dgemv_("T", n, n, &c_b145, &a[a_offset], lda, &b[b_offset], &c__1,
		     &c_b74, &work[1], &c__1);
	    t2 = dsecnd_();
...
/*        Compute A=L*Q   
	    ...
	    nb = ilaenv_(&c__1, "DGELQF", " ", m, n, &c_n1, &c_n1, (ftnlen)6, 
		    (ftnlen)1);
	    lstime_1.opcnt[gelqf - 1] += dopla_("DGELQF", m, n, &c__0, &c__0, 
		    &nb);
	    t1 = dsecnd_();
	    i__2 = *lwork - iwork + 1;
