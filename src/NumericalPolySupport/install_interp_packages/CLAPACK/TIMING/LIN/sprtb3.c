...
/* Subroutine */ int sprtb3_(char *lab1, char *lab2, integer *nk, integer *
	kval, integer *lval, integer *nn, integer *nval, integer *nlda, real *
	reslts, integer *ldr1, integer *ldr2, integer *nout, ftnlen lab1_len, 
	ftnlen lab2_len)
{
    /* Format strings */
