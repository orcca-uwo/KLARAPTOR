...
/* Subroutine */ int stimpo_(char *line, integer *nn, integer *nval, integer *
	nns, integer *nsval, integer *nnb, integer *nbval, integer *nlda, 
	integer *ldaval, real *timmin, real *a, real *b, integer *iwork, real 
	...
	ftnlen line_len)
{
    ...
    static char subnam[6*3] = "SPOTRF" "SPOTRS" "SPOTRI";
    ...
    extern /* Subroutine */ int sprtbl_(char *, char *, integer *, integer *, 
	    ...
	    integer *, ftnlen, ftnlen), spotrf_(char *, integer *, real *, 
...
L20:
			...
			ops = sopla_("SPOTRF", &n, &n, &c__0, &c__0, &nb);
...
L40:
			...
			time = (time - untime) / (real) ic;
			ops = sopla_("SPOTRI", &n, &n, &c__0, &c__0, &nb);
...
/*              Time SPOTRS */
		...
		if (timsub[1]) {
			...
			s1 = second_();
L60:
			spotrs_(uplo, &n, &nrhs, &a[1], &lda, &b[1], &ldb, &
				info);
			s2 = second_();
			time = s2 - s1;
			++ic;
...
L70:
			...
			time = (time - untime) / (real) ic;
			ops = sopla_("SPOTRS", &n, &nrhs, &c__0, &c__0, &c__0);
