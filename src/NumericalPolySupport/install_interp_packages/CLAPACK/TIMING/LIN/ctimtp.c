...
/* Subroutine */ int ctimtp_(char *line, integer *nn, integer *nval, integer *
	nns, integer *nsval, integer *la, real *timmin, complex *a, complex *
	b, real *reslts, integer *ldr1, integer *ldr2, integer *ldr3, integer 
	*nout, ftnlen line_len)
{
    /* Initialized data */

    static char subnam[6*2] = "CTPTRI" "CTPTRS";
    ...
    extern /* Subroutine */ int ctptri_(char *, char *, integer *, complex *, 
	    integer *), sprtbl_(char *, char *, integer *, 
	    integer *, integer *, integer *, integer *, real *, integer *, 
	    integer *, integer *, ftnlen, ftnlen), ctptrs_(char *, char *, 
...
/*           Time CTPTRI */
		...
		s1 = second_();
L10:
		ctptri_(uplo, "Non-unit", &n, &a[1], &info);
		s2 = second_();
		time = s2 - s1;
		++ic;
		if (time < *timmin) {
...
L20:
		...
		ops = sopla_("CTPTRI", &n, &n, &c__0, &c__0, &c__0)
			;
...
/*           Time CTPTRS */
		...
		for (i__ = 1; i__ <= i__2; ++i__) {
		    ...
		    s1 = second_();
L30:
		    ctptrs_(uplo, "No transpose", "Non-unit", &n, &nrhs, &a[1]
			    , &b[1], &ldb, &info);
		    s2 = second_();
		    time = s2 - s1;
		    ++ic;
...
L40:
		    ...
		    time = (time - untime) / (real) ic;
		    ops = sopla_("CTPTRS", &n, &nrhs, &c__0, &c__0, &c__0);
