...
/* Subroutine */ int dprtbv_(char *subnam, integer *ntypes, logical *dotype, 
	integer *nsizes, integer *mm, integer *nn, integer *inparm, char *
	pnames, integer *nparms, integer *np1, integer *np2, doublereal *ops, 
	integer *ldo1, integer *ldo2, doublereal *times, integer *ldt1, 
	integer *ldt2, doublereal *rwork, logical *llwork, integer *nout, 
	ftnlen subnam_len, ftnlen pnames_len)
{
    /* Format strings */
    ...
    extern /* Subroutine */ int dprtbr_(char *, char *, integer *, logical *, 
...
/*     Execution Times */
    ...
    s_wsfe(&io___11);
    e_wsfe();
    dprtbr_("Type", "M,N ", ntypes, &dotype[1], nsizes, &mm[1], &nn[1], 
