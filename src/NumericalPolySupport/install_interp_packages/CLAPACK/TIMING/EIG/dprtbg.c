...
/* Subroutine */ int dprtbg_(char *subnam, integer *ntypes, logical *dotype, 
	integer *nsizes, integer *nn, integer *inparm, char *pnames, integer *
	nparms, integer *np1, integer *np2, integer *np3, integer *np4, 
	integer *np5, integer *np6, doublereal *ops, integer *ldo1, integer *
	ldo2, doublereal *times, integer *ldt1, integer *ldt2, doublereal *
	rwork, logical *llwork, integer *nout, ftnlen subnam_len, ftnlen 
	pnames_len)
{
    /* Format strings */
    ...
    static char fmt_9993[] = "(\002( 5X, : I5 , 6( \002,i2,\002X, I5, : ) "
	    ")\002)";
    static char fmt_9994[] = "(\002( 5X, : 'line ' , 6( \002,i2,\002X, A, : "
	    ") )\002)";
    ...
    static char frmata[40];
    extern doublereal dmflop_(doublereal *, doublereal *, integer *);
    static char frmati[40];
    static integer ilines;
    extern /* Subroutine */ int dprtbs_(char *, char *, integer *, logical *, 
    ...
    static icilist io___15 = { 0, frmati, 0, fmt_9993, 40, 1 };
    static icilist io___18 = { 0, frmata, 0, fmt_9994, 40, 1 };
...
/*     Execution Times */
    ...
    s_wsfe(&io___26);
    e_wsfe();
    dprtbs_("Type", "N ", ntypes, &dotype[1], nsizes, &nn[1], nparms, &llwork[
...
/*     Megaflop Rates */
	...
	for (jt = 1; jt <= i__2; ++jt) {
		...
		for (jp = 1; jp <= i__3; ++jp) {
		    ...
		    rwork[i__] = dmflop_(&ops_ref(jp, jt, js), &times_ref(jp, 
			    jt, js), &iinfo);
/* L40: */
		}
	    }
