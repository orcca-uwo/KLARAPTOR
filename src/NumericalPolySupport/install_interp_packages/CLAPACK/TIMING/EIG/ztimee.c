...
/* Main program */ MAIN__(void)
{
    ...
    integer i__1;
    doublereal d__1;
    static doublecomplex equiv_0[1008000], equiv_1[2400], equiv_2[649241];
    static doublereal equiv_3[489601];
...
#define d__ (equiv_1)
    ...
    static char c3[3];
    static doublereal e2[400];
    extern /* Subroutine */ int ztim21_(char *, integer *, integer *, integer 
	    ...
	    *, doublereal *, integer *, integer *, doublecomplex *, 
	    ...
	    doublereal *, integer *, integer *, integer *, integer *, ftnlen),
	     ztim22_(char *, integer *, integer *, integer *, logical *, 
	    ...
	    *, doublecomplex *, doublereal *, doublereal *, doublereal *, 
	    ...
	    integer *, integer *, integer *, integer *, ftnlen), ztim51_(char 
	    *, integer *, integer *, integer *, logical *, integer *, integer 
	    *, integer *, integer *, integer *, integer *, integer *, 
	    doublereal *, integer *, integer *, doublecomplex *, doublereal *,
	     doublereal *, doublecomplex *, doublereal *, doublereal *, 
	    doublecomplex *, doublereal *, doublereal *, doublecomplex *, 
	    doublereal *, doublereal *, doublecomplex *, doublereal *, 
	    doublereal *, doublecomplex *, doublereal *, doublereal *, 
    ...
    extern /* Subroutine */ int ztim26_(char *, integer *, integer *, integer 
...
#define workr ((doublereal *)equiv_2)
    static integer iwork2[20406];
#define ar ((doublereal *)equiv_0)
#define rwork1 (equiv_3)
#define dr ((doublereal *)equiv_1)
    static integer nn;
    ...
    static doublereal opcnts[24000]	/* was [10][10][12][20] */, result[
	    24000]	/* was [10][10][12][20] */;
...
/*     -------------------------------------   
    ...
    if (lsamen_(&c__3, c3, "ZHS") || lsamen_(&c__3, c3, 
	    "NEP")) {
	ztim21_(line, &nn, nval, &maxtyp, dotype, &nparms, nbval, nsval, 
...
/*     ----------------------------------   
       ...
       ---------------------------------- */
	    ...
	    c__3, c3, "SEP")) {
	ztim22_(line, &nn, nval, &maxtyp, dotype, &nparms, nbval, ldaval, &
...
/*     ----------------------------------   
       ...
       ---------------------------------- */
	    ...
	    c__3, c3, "SVD")) {
	ztim26_(line, &nn, nval, mval, &maxtyp, dotype, &nparms, nbval, 
...
/*     -------------------------------------   
    ...
    } else if (lsamen_(&c__3, c3, "ZHG") || lsamen_(&
	    c__3, c3, "GEP")) {
	ztim51_(line, &nn, nval, &maxtyp, dotype, &nparms, nbval, nsval, 
...
/* Main program alias */ int ztimee_ () { MAIN__ (); return 0; }
