...
static real c_b235 = 0.f;
static real c_b301 = 1.f;
	 ...
	 real *work, integer *lwork, integer *iwork, integer *info)
{
    ...
    extern doublereal sopla_(char *, integer *, integer *, integer *, integer 
	    *, integer *);
    static integer itaup, itauq, wrkbl, mnthr;
    ...
    extern doublereal sopla2_(char *, char *, integer *, integer *, integer *,
	     ...
	     integer *, integer *);
    static integer ie, nb, il, ir, bdspac, iu;
...
/*              Compute A=Q*R   
		...
		nb = ilaenv_(&c__1, "SGEQRF", " ", m, n, &c_n1, &c_n1, (
			ftnlen)6, (ftnlen)1);
		latime_1.ops += sopla_("SGEQRF", m, n, &c__0, &c__0, &nb);
		i__1 = *lwork - nwork + 1;
...
/*              Zero out below R */
		...
		i__1 = *n - 1;
		i__2 = *n - 1;
		slaset_("L", &i__1, &i__2, &c_b235, &c_b235, &a_ref(2, 1), 
			lda);
		ie = 1;
		itauq = ie + *n;
		itaup = itauq + *n;
...
/*              Bidiagonalize R in A   
		...
		nb = ilaenv_(&c__1, "SGEBRD", " ", n, n, &c_n1, &c_n1, (
			ftnlen)6, (ftnlen)1);
		latime_1.ops += sopla_("SGEBRD", n, n, &c__0, &c__0, &nb);
		i__1 = *lwork - nwork + 1;
...
/*              Copy R to WORK(IR), zeroing out below it */
		...
		i__1 = *n - 1;
		i__2 = *n - 1;
		slaset_("L", &i__1, &i__2, &c_b235, &c_b235, &work[ir + 1], &
			ldwrkr);

/*              Generate Q in A   
                (Workspace: need N*N+2*N, prefer N*N+N+N*NB) */

		nb = ilaenv_(&c__1, "SORGQR", " ", m, n, n, &c_n1, (ftnlen)6, 
			(ftnlen)1);
		latime_1.ops += sopla_("SORGQR", m, n, n, &c__0, &nb);
		i__1 = *lwork - nwork + 1;
...
/*              Overwrite WORK(IU) by left singular vectors of R   
		...
		nb = ilaenv_(&c__1, "SORMBR", "QLN", n, n, n, &c_n1, (ftnlen)
			6, (ftnlen)3);
		latime_1.ops += sopla2_("SORMBR", "QLN", n, n, n, &c__0, &nb);
		i__1 = *lwork - nwork + 1;
		sormbr_("Q", "L", "N", n, n, n, &work[ir], &ldwrkr, &work[
			itauq], &work[iu], n, &work[nwork], &i__1, &ierr);
		nb = ilaenv_(&c__1, "SORMBR", "PRT", n, n, n, &c_n1, (ftnlen)
			6, (ftnlen)3);
		latime_1.ops += sopla2_("SORMBR", "PRT", n, n, n, &c__0, &nb);
		i__1 = *lwork - nwork + 1;
...
/* Computing MIN */
		    ...
		    latime_1.ops += sopbl3_("SGEMM ", &chunk, n, n)
			    ;
		    sgemm_("N", "N", &chunk, n, n, &c_b301, &a_ref(i__, 1), 
			    lda, &work[iu], n, &c_b235, &work[ir], &ldwrkr);
		    slacpy_("F", &chunk, n, &work[ir], &ldwrkr, &a_ref(i__, 1)
			    , lda);
/* L10: */
		}
...
/*              Copy R to WORK(IR), zeroing out below it */
		...
		i__2 = *n - 1;
		i__1 = *n - 1;
		slaset_("L", &i__2, &i__1, &c_b235, &c_b235, &work[ir + 1], &
			ldwrkr);
...
/*              Bidiagonalize R in WORK(IR)   
   ...
   Computing MAX */
		i__2 = 1, i__1 = ilaenv_(&c__1, "SGEBRD", " ", n, n, &c_n1, &
...
/*              Multiply Q in A by left singular vectors of R in   
		...
		latime_1.ops += sopbl3_("SGEMM ", m, n, n);
		sgemm_("N", "N", m, n, n, &c_b301, &a[a_offset], lda, &work[
...
/*              Generate Q in U   
                (Workspace: need N*N+2*N, prefer N*N+N+N*NB) */
		nb = ilaenv_(&c__1, "SORGQR", " ", m, m, n, &c_n1, (ftnlen)6, 
			(ftnlen)1);
		latime_1.ops += sopla_("SORGQR", m, m, n, &c__0, &nb);
		i__2 = *lwork - nwork + 1;
...
/*              Produce R in A, zeroing out other entries */
		...
		i__2 = *n - 1;
		i__1 = *n - 1;
		slaset_("L", &i__2, &i__1, &c_b235, &c_b235, &a_ref(2, 1), 
			lda);
		ie = itau;
		itauq = ie + *n;
		itaup = itauq + *n;
...
/*              Multiply Q in U by left singular vectors of R in   
		...
		latime_1.ops += sopbl3_("SGEMM ", m, n, n);
		sgemm_("N", "N", m, n, n, &c_b301, &u[u_offset], ldu, &work[
...
/*           Bidiagonalize A   
   ...
   Computing MAX */
	    i__2 = 1, i__1 = ilaenv_(&c__1, "SGEBRD", " ", m, n, &c_n1, &c_n1,
		     (ftnlen)6, (ftnlen)1);
	    nb = max(i__2,i__1);
	    latime_1.ops += sopla_("SGEBRD", m, n, &c__0, &c__0, &nb);
	    i__2 = *lwork - nwork + 1;
...
/*                 WORK( IU ) is M by N */
		    ...
		    ldwrku = *m;
		    nwork = iu + ldwrku * *n;
		    slaset_("F", m, n, &c_b235, &c_b235, &work[iu], &ldwrku);
		} else {
...
/*                 Overwrite WORK(IU) by left singular vectors of A   
		    ...
		    nb = ilaenv_(&c__1, "SORMBR", "QLN", m, n, n, &c_n1, (
			    ftnlen)6, (ftnlen)3);
		    latime_1.ops += sopla2_("SORMBR", "QLN", m, n, n, &c__0, &
			    nb);
		    i__2 = *lwork - nwork + 1;
...
/*                 Generate Q in A   
		    ...
		    nb = ilaenv_(&c__1, "SORGBR", "Q", m, n, n, &c_n1, (
			    ftnlen)6, (ftnlen)1);
		    latime_1.ops += sopla2_("SORGBR", "Q", m, n, n, &c__0, &
			    nb);
		    i__2 = *lwork - nwork + 1;
...
/* Computing MIN */
			...
			sgemm_("N", "N", &chunk, n, n, &c_b301, &a_ref(i__, 1)
				, lda, &work[iu], &ldwrku, &c_b235, &work[ir],
				 &ldwrkr);
			slacpy_("F", &chunk, n, &work[ir], &ldwrkr, &a_ref(
				i__, 1), lda);
/* L20: */
		    }
		}
...
/*              Perform bidiagonal SVD, computing left singular vectors   
		...
		slaset_("F", m, n, &c_b235, &c_b235, &u[u_offset], ldu);
		sbdsdc_("U", "I", n, &s[1], &work[ie], &u[u_offset], ldu, &vt[
			vt_offset], ldvt, dum, idum, &work[nwork], &iwork[1], 
			info);
...
/*              Overwrite U by left singular vectors of A and VT   
		...
		nb = ilaenv_(&c__1, "SORMBR", "QLN", m, n, n, &c_n1, (ftnlen)
			6, (ftnlen)3);
		latime_1.ops += sopla2_("SORMBR", "QLN", m, n, n, &c__0, &nb);
		i__1 = *lwork - nwork + 1;
		sormbr_("Q", "L", "N", m, n, n, &a[a_offset], lda, &work[
...
/*              Perform bidiagonal SVD, computing left singular vectors   
		...
		slaset_("F", m, m, &c_b235, &c_b235, &u[u_offset], ldu);
		sbdsdc_("U", "I", n, &s[1], &work[ie], &u[u_offset], ldu, &vt[
			vt_offset], ldvt, dum, idum, &work[nwork], &iwork[1], 
			info);
...
/*              Set the right corner of U to identity matrix */
		...
		i__1 = *m - *n;
		i__2 = *m - *n;
		slaset_("F", &i__1, &i__2, &c_b235, &c_b301, &u_ref(*n + 1, *
			n + 1), ldu);
...
/*              Overwrite U by left singular vectors of A and VT   
		...
		nb = ilaenv_(&c__1, "SORMBR", "QLN", m, m, n, &c_n1, (ftnlen)
			6, (ftnlen)3);
		latime_1.ops += sopla2_("SORMBR", "QLN", m, m, n, &c__0, &nb);
		i__1 = *lwork - nwork + 1;
		sormbr_("Q", "L", "N", m, m, n, &a[a_offset], lda, &work[
			itauq], &u[u_offset], ldu, &work[nwork], &i__1, &ierr);
		nb = ilaenv_(&c__1, "SORMBR", "PRT", n, n, m, &c_n1, (ftnlen)
			6, (ftnlen)3);
		latime_1.ops += sopla2_("SORMBR", "PRT", n, n, m, &c__0, &nb);
		i__1 = *lwork - nwork + 1;
...
/*              Compute A=L*Q   
		...
		nb = ilaenv_(&c__1, "SGELQF", " ", m, n, &c_n1, &c_n1, (
			ftnlen)6, (ftnlen)1);
		latime_1.ops += sopla_("SGELQF", m, n, &c__0, &c__0, &nb);
		i__1 = *lwork - nwork + 1;
...
/*              Zero out above L */
		...
		i__1 = *m - 1;
		i__2 = *m - 1;
		slaset_("U", &i__1, &i__2, &c_b235, &c_b235, &a_ref(1, 2), 
			lda);
		ie = 1;
		itauq = ie + *m;
		itaup = itauq + *m;
...
/*              Bidiagonalize L in A   
		...
		nb = ilaenv_(&c__1, "SGEBRD", " ", m, m, &c_n1, &c_n1, (
			ftnlen)6, (ftnlen)1);
		latime_1.ops += sopla_("SGEBRD", m, m, &c__0, &c__0, &nb);
		i__1 = *lwork - nwork + 1;
...
/*              Copy L to WORK(IL), zeroing about above it */
		...
		i__1 = *m - 1;
		i__2 = *m - 1;
		slaset_("U", &i__1, &i__2, &c_b235, &c_b235, &work[il + 
			ldwrkl], &ldwrkl);

/*              Generate Q in A   
                (Workspace: need M*M+2*M, prefer M*M+M+M*NB) */

		nb = ilaenv_(&c__1, "SORGLQ", " ", m, n, m, &c_n1, (ftnlen)6, 
			(ftnlen)1);
		latime_1.ops += sopla_("SORGLQ", m, n, m, &c__0, &nb);
		i__1 = *lwork - nwork + 1;
...
/*              Overwrite U by left singular vectors of L and WORK(IVT)   
		...
		nb = ilaenv_(&c__1, "SORMBR", "QLN", m, m, m, &c_n1, (ftnlen)
			6, (ftnlen)3);
		latime_1.ops += sopla2_("SORMBR", "QLN", m, m, m, &c__0, &nb);
		i__1 = *lwork - nwork + 1;
		sormbr_("Q", "L", "N", m, m, m, &work[il], &ldwrkl, &work[
			itauq], &u[u_offset], ldu, &work[nwork], &i__1, &ierr);
		nb = ilaenv_(&c__1, "SORMBR", "PRT", m, m, m, &c_n1, (ftnlen)
			6, (ftnlen)3);
		latime_1.ops += sopla2_("SORMBR", "PRT", m, m, m, &c__0, &nb);
		i__1 = *lwork - nwork + 1;
...
/* Computing MIN */
		    i__3 = *n - i__ + 1;
		    blk = min(i__3,chunk);
		    latime_1.ops += sopbl3_("SGEMM ", m, &blk, m);
		    sgemm_("N", "N", m, &blk, m, &c_b301, &work[ivt], m, &
			    a_ref(1, i__), lda, &c_b235, &work[il], &ldwrkl);
		    slacpy_("F", m, &blk, &work[il], &ldwrkl, &a_ref(1, i__), 
			    lda);
/* L30: */
		}
...
/*              Copy L to WORK(IL), zeroing out above it */
		...
		i__2 = *m - 1;
		i__1 = *m - 1;
		slaset_("U", &i__2, &i__1, &c_b235, &c_b235, &work[il + 
			ldwrkl], &ldwrkl);
...
/*              Bidiagonalize L in WORK(IU), copying result to U   
   ...
   Computing MAX */
		i__2 = 1, i__1 = ilaenv_(&c__1, "SGEBRD", " ", m, m, &c_n1, &
			c_n1, (ftnlen)6, (ftnlen)1);
		nb = max(i__2,i__1);
		latime_1.ops += sopla_("SGEBRD", m, m, &c__0, &c__0, &nb);
		i__2 = *lwork - nwork + 1;
...
/*              Multiply right singular vectors of L in WORK(IL) by   
		...
		latime_1.ops += sopbl3_("SGEMM ", m, n, m);
		sgemm_("N", "N", m, n, m, &c_b301, &work[il], &ldwrkl, &a[
...
/*              Generate Q in VT   
		...
		nb = ilaenv_(&c__1, "SORGLQ", " ", n, n, m, &c_n1, (ftnlen)6, 
			(ftnlen)1);
		latime_1.ops += sopla_("SORGLQ", n, n, m, &c__0, &nb);
		i__2 = *lwork - nwork + 1;
...
/*              Produce L in A, zeroing out other entries */
		...
		i__2 = *m - 1;
		i__1 = *m - 1;
		slaset_("U", &i__2, &i__1, &c_b235, &c_b235, &a_ref(1, 2), 
			lda);
		ie = itau;
		itauq = ie + *m;
		itaup = itauq + *m;
...
/*              Multiply right singular vectors of L in WORK(IVT) by   
		...
		latime_1.ops += sopbl3_("SGEMM ", m, n, m);
		sgemm_("N", "N", m, n, m, &c_b301, &work[ivt], &ldwkvt, &vt[
...
/*                 WORK( IVT ) is M by N */
		    ...
		    slaset_("F", m, n, &c_b235, &c_b235, &work[ivt], &ldwkvt);
		    nwork = ivt + ldwkvt * *n;
		} else {
...
/*                 Overwrite WORK(IVT) by left singular vectors of A   
		    ...
		    nb = ilaenv_(&c__1, "SORMBR", "PRT", m, n, m, &c_n1, (
			    ftnlen)6, (ftnlen)3);
		    latime_1.ops += sopla2_("SORMBR", "PRT", m, n, m, &c__0, &
			    nb);
		    i__2 = *lwork - nwork + 1;
...
/*                 Generate P**T in A   
		    ...
		    nb = ilaenv_(&c__1, "SORGBR", "P", m, n, m, &c_n1, (
			    ftnlen)6, (ftnlen)1);
		    latime_1.ops += sopla2_("SORGBR", "P", m, n, m, &c__0, &
			    nb);
		    i__2 = *lwork - nwork + 1;
...
/* Computing MIN */
			...
			blk = min(i__3,chunk);
			latime_1.ops += sopbl3_("SGEMM ", m, &blk, m);
			sgemm_("N", "N", m, &blk, m, &c_b301, &work[ivt], &
				ldwkvt, &a_ref(1, i__), lda, &c_b235, &work[
				il], m);
			slacpy_("F", m, &blk, &work[il], m, &a_ref(1, i__), 
				lda);
/* L40: */
		    }
		}
...
/*              Perform bidiagonal SVD, computing left singular vectors   
		...
		slaset_("F", m, n, &c_b235, &c_b235, &vt[vt_offset], ldvt);
...
/*              Overwrite U by left singular vectors of A and VT   
		...
		sormbr_("Q", "L", "N", m, m, n, &a[a_offset], lda, &work[
			itauq], &u[u_offset], ldu, &work[nwork], &i__1, &ierr);
		nb = ilaenv_(&c__1, "SORMBR", "PRT", m, n, m, &c_n1, (ftnlen)
			6, (ftnlen)3);
		latime_1.ops += sopla2_("SORMBR", "PRT", m, n, m, &c__0, &nb);
		i__1 = *lwork - nwork + 1;
		sormbr_("P", "R", "T", m, n, m, &a[a_offset], lda, &work[
			itaup], &vt[vt_offset], ldvt, &work[nwork], &i__1, &
			ierr);
...
/*              Perform bidiagonal SVD, computing left singular vectors   
		...
		slaset_("F", n, n, &c_b235, &c_b235, &vt[vt_offset], ldvt);
		sbdsdc_("L", "I", m, &s[1], &work[ie], &u[u_offset], ldu, &vt[
			vt_offset], ldvt, dum, idum, &work[nwork], &iwork[1], 
			info);
...
/*              Set the right corner of VT to identity matrix */
		...
		i__1 = *n - *m;
		i__2 = *n - *m;
		slaset_("F", &i__1, &i__2, &c_b235, &c_b301, &vt_ref(*m + 1, *
			m + 1), ldvt);
