...
/*        apply random reflection to A(i:n,i:n) from the left   
	...
	i__1 = *n - i__ + 1;
	zhemv_("Lower", &i__1, &tau, &a_ref(i__, i__), lda, &work[1], &c__1, &
		c_b1, &work[*n + 1], &c__1);
...
/*        generate reflection to annihilate A(k+i+1:n,i) */
	...
	i__2 = *n - *k - i__ + 1;
	wn = dznrm2_(&i__2, &a_ref(*k + i__, i__), &c__1);
	d__1 = wn / z_abs(&a_ref(*k + i__, i__));
	...
	if (wn == 0.) {
	    ...
	    i__2 = *n - *k - i__;
	    z_div(&z__1, &c_b2, &wb);
	    zscal_(&i__2, &z__1, &a_ref(*k + i__ + 1, i__), &c__1);
	    i__2 = a_subscr(*k + i__, i__);
...
/*        apply reflection to A(k+i:n,i+1:k+i-1) from the left */
	...
	i__2 = *n - *k - i__ + 1;
	i__3 = *k - 1;
	zgemv_("Conjugate transpose", &i__2, &i__3, &c_b2, &a_ref(*k + i__, 
		i__ + 1), lda, &a_ref(*k + i__, i__), &c__1, &c_b1, &work[1], 
		&c__1);
	i__2 = *n - *k - i__ + 1;
	i__3 = *k - 1;
	z__1.r = -tau.r, z__1.i = -tau.i;
	zgerc_(&i__2, &i__3, &z__1, &a_ref(*k + i__, i__), &c__1, &work[1], &
...
/*        apply reflection to A(k+i:n,k+i:n) from the left and the right   
	...
	i__2 = *n - *k - i__ + 1;
	zhemv_("Lower", &i__2, &tau, &a_ref(*k + i__, *k + i__), lda, &a_ref(*
...
/*        compute  v := y - 1/2 * tau * ( y, u ) * u */
	...
	z__2.r = z__3.r * tau.r - z__3.i * tau.i, z__2.i = z__3.r * tau.i + 
		z__3.i * tau.r;
	i__2 = *n - *k - i__ + 1;
	zdotc_(&z__4, &i__2, &work[1], &c__1, &a_ref(*k + i__, i__), &c__1);
	z__1.r = z__2.r * z__4.r - z__2.i * z__4.i, z__1.i = z__2.r * z__4.i 
		+ z__2.i * z__4.r;
	alpha.r = z__1.r, alpha.i = z__1.i;
	i__2 = *n - *k - i__ + 1;
	zaxpy_(&i__2, &alpha, &a_ref(*k + i__, i__), &c__1, &work[1], &c__1);

/*        apply hermitian rank-2 update to A(k+i:n,k+i:n) */

	i__2 = *n - *k - i__ + 1;
	z__1.r = -1., z__1.i = 0.;
	zher2_("Lower", &i__2, &z__1, &a_ref(*k + i__, i__), &c__1, &work[1], 
