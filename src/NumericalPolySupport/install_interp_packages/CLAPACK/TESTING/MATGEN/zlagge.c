...
/*           multiply A(i:m,i:n) by random reflection from the left */
	    ...
	    i__1 = *m - i__ + 1;
	    i__2 = *n - i__ + 1;
	    zgemv_("Conjugate transpose", &i__1, &i__2, &c_b2, &a_ref(i__, 
...
/*           multiply A(i:m,i:n) by random reflection from the right */
	    ...
	    i__1 = *m - i__ + 1;
	    i__2 = *n - i__ + 1;
	    zgemv_("No transpose", &i__1, &i__2, &c_b2, &a_ref(i__, i__), lda,
...
/*              generate reflection to annihilate A(kl+i+1:m,i) */
		...
		i__2 = *m - *kl - i__ + 1;
		wn = dznrm2_(&i__2, &a_ref(*kl + i__, i__), &c__1);
		d__1 = wn / z_abs(&a_ref(*kl + i__, i__));
		...
		if (wn == 0.) {
		    ...
		    i__2 = *m - *kl - i__;
		    z_div(&z__1, &c_b2, &wb);
		    zscal_(&i__2, &z__1, &a_ref(*kl + i__ + 1, i__), &c__1);
		    i__2 = a_subscr(*kl + i__, i__);
...
/*              apply reflection to A(kl+i:m,i+1:n) from the left */
		...
		i__2 = *m - *kl - i__ + 1;
		i__3 = *n - i__;
		zgemv_("Conjugate transpose", &i__2, &i__3, &c_b2, &a_ref(*kl 
			+ i__, i__ + 1), lda, &a_ref(*kl + i__, i__), &c__1, &
			c_b1, &work[1], &c__1);
		i__2 = *m - *kl - i__ + 1;
		i__3 = *n - i__;
		z__1.r = -tau.r, z__1.i = -tau.i;
		zgerc_(&i__2, &i__3, &z__1, &a_ref(*kl + i__, i__), &c__1, &
...
/*              generate reflection to annihilate A(i,ku+i+1:n) */
		...
		i__2 = *n - *ku - i__ + 1;
		wn = dznrm2_(&i__2, &a_ref(i__, *ku + i__), lda);
		d__1 = wn / z_abs(&a_ref(i__, *ku + i__));
		...
		if (wn == 0.) {
		    ...
		    i__2 = *n - *ku - i__;
		    z_div(&z__1, &c_b2, &wb);
		    zscal_(&i__2, &z__1, &a_ref(i__, *ku + i__ + 1), lda);
		    i__2 = a_subscr(i__, *ku + i__);
		    a[i__2].r = 1., a[i__2].i = 0.;
		    z_div(&z__1, &wb, &wa);
		    d__1 = z__1.r;
...
/*              apply reflection to A(i+1:m,ku+i:n) from the right */
		...
		i__2 = *n - *ku - i__ + 1;
		zlacgv_(&i__2, &a_ref(i__, *ku + i__), lda);
		i__2 = *m - i__;
		i__3 = *n - *ku - i__ + 1;
		...
		i__3 = *n - *ku - i__ + 1;
		z__1.r = -tau.r, z__1.i = -tau.i;
		zgerc_(&i__2, &i__3, &z__1, &work[1], &c__1, &a_ref(i__, *ku 
