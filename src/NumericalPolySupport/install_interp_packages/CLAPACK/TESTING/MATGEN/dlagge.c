...
/*           multiply A(i:m,i:n) by random reflection from the left */
	    ...
	    i__1 = *m - i__ + 1;
	    i__2 = *n - i__ + 1;
	    dgemv_("Transpose", &i__1, &i__2, &c_b11, &a_ref(i__, i__), lda, &
...
/*           multiply A(i:m,i:n) by random reflection from the right */
	    ...
	    i__1 = *m - i__ + 1;
	    i__2 = *n - i__ + 1;
	    dgemv_("No transpose", &i__1, &i__2, &c_b11, &a_ref(i__, i__), 
...
/*              generate reflection to annihilate A(kl+i+1:m,i) */
		...
		i__2 = *m - *kl - i__ + 1;
		wn = dnrm2_(&i__2, &a_ref(*kl + i__, i__), &c__1);
		wa = d_sign(&wn, &a_ref(*kl + i__, i__));
		if (wn == 0.) {
		    tau = 0.;
		} else {
		    ...
		    i__2 = *m - *kl - i__;
		    d__1 = 1. / wb;
		    dscal_(&i__2, &d__1, &a_ref(*kl + i__ + 1, i__), &c__1);
		    a_ref(*kl + i__, i__) = 1.;
		    tau = wb / wa;
		}
...
/*              apply reflection to A(kl+i:m,i+1:n) from the left */
		...
		i__2 = *m - *kl - i__ + 1;
		i__3 = *n - i__;
		dgemv_("Transpose", &i__2, &i__3, &c_b11, &a_ref(*kl + i__, 
			i__ + 1), lda, &a_ref(*kl + i__, i__), &c__1, &c_b13, 
			&work[1], &c__1);
		i__2 = *m - *kl - i__ + 1;
		i__3 = *n - i__;
		d__1 = -tau;
		dger_(&i__2, &i__3, &d__1, &a_ref(*kl + i__, i__), &c__1, &
...
/*              generate reflection to annihilate A(i,ku+i+1:n) */
		...
		i__2 = *n - *ku - i__ + 1;
		wn = dnrm2_(&i__2, &a_ref(i__, *ku + i__), lda);
		wa = d_sign(&wn, &a_ref(i__, *ku + i__));
		if (wn == 0.) {
		    tau = 0.;
		} else {
		    ...
		    i__2 = *n - *ku - i__;
		    d__1 = 1. / wb;
		    dscal_(&i__2, &d__1, &a_ref(i__, *ku + i__ + 1), lda);
		    a_ref(i__, *ku + i__) = 1.;
		    tau = wb / wa;
		}
...
/*              apply reflection to A(i+1:m,ku+i:n) from the right */
		...
		i__2 = *m - i__;
		i__3 = *n - *ku - i__ + 1;
		dgemv_("No transpose", &i__2, &i__3, &c_b11, &a_ref(i__ + 1, *
			ku + i__), lda, &a_ref(i__, *ku + i__), lda, &c_b13, &
			work[1], &c__1);
		i__2 = *m - i__;
		i__3 = *n - *ku - i__ + 1;
		d__1 = -tau;
		dger_(&i__2, &i__3, &d__1, &work[1], &c__1, &a_ref(i__, *ku + 
