	...
	doublereal *wr, doublereal *wi, doublereal *work, doublereal *result)
{
    ...
    static doublereal unfl, wmat[4]	/* was [2][2] */, temp1;
    static integer j;
    extern /* Subroutine */ int dgemm_(char *, char *, integer *, integer *, 
	    integer *, doublereal *, doublereal *, integer *, doublereal *, 
	    integer *, doublereal *, doublereal *, integer *);
    static integer iecol;
    ...
    static doublereal enrmin, enrmax;
...
/* L40: */
	...
	for (j = 1; j <= i__1; ++j) {
		...
		if (ipair == 1) {
/* Computing MAX */
		    d__3 = work[jvec], d__4 = (d__1 = e_ref(j, jvec), abs(
			    d__1)) + (d__2 = e_ref(j, jvec + 1), abs(d__2));
...
/* Computing MAX */
		    d__2 = work[jvec], d__3 = (d__1 = e_ref(j, jvec), abs(
			    d__1));
...
/*     Norm of error:   
	...
	if (ipair == 1) {
	    ...
	    dgemm_(transe, transw, n, &c__2, &c__2, &c_b25, &e_ref(ierow, 
	    ...
	    daxpy_(n, &wr[jcol], &e_ref(ierow, iecol), &ince, &work[*n * (
		    jcol - 1) + 1], &c__1);
	    ipair = 0;
	}
