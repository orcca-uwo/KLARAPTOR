	...
	integer *knt, integer *nin)
{
    ...
    static real wiin[20], vmax, tnrm, wrin[20], work[1200], vmul, stmp[20];
    static integer i__, j, m, n;
    static real s[20], t[400]	/* was [20][20] */, v;
    extern /* Subroutine */ int sscal_(integer *, real *, real *, integer *);
    static real sepin[20], vimin, tolin, vrmin;
    static integer iwork[40];
    extern /* Subroutine */ int scopy_(integer *, real *, integer *, real *, 
	    integer *);
    static real witmp[20], wrtmp[20], le[400]	/* was [20][20] */;
    extern /* Subroutine */ int slabad_(real *, real *);
    static real re[400]	/* was [20][20] */, wi[20];
    ...
    extern /* Subroutine */ int slacpy_(char *, integer *, integer *, real *, 
	    ...
	    *, integer *);
    static real septmp[20];
    extern /* Subroutine */ int strsna_(char *, char *, logical *, integer *, 
	    real *, integer *, real *, integer *, real *, integer *, real *, 
	    real *, integer *, integer *, real *, integer *, integer *, 
	    integer *);
    static real smlnum, val[3], dum[1], eps, sep[20], sin__[20], tol, tmp[400]
	    	/* was [20][20] */;
...
/*        Select first real and first complex eigenvalue */
	...
	if (wi[0] == 0.f) {
		...
		if (ifnd == 1 || wi[i__ - 1] == 0.f) {
		    ...
		    lcmp[1] = i__;
		    lcmp[2] = i__ + 1;
		    scopy_(&n, &re_ref(1, i__), &c__1, &re_ref(1, 2), &c__1);
		    scopy_(&n, &re_ref(1, i__ + 1), &c__1, &re_ref(1, 3), &
			    c__1);
		    scopy_(&n, &le_ref(1, i__), &c__1, &le_ref(1, 2), &c__1);
		    scopy_(&n, &le_ref(1, i__ + 1), &c__1, &le_ref(1, 3), &
			    c__1);
		}
/* L190: */
	    }
		...
		if (ifnd == 1 || wi[i__ - 1] != 0.f) {
		    ...
		    lcmp[2] = i__;
		    ifnd = 1;
		    scopy_(&n, &re_ref(1, i__), &c__1, &re_ref(1, 3), &c__1);
		    scopy_(&n, &le_ref(1, i__), &c__1, &le_ref(1, 3), &c__1);
		}
/* L200: */
	    }
	    if (ifnd == 0) {
