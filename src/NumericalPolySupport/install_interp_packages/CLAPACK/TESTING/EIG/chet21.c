...
/*        ITYPE=1: error = A - U S U* */
	...
	for (j = 1; j <= i__1; ++j) {
	    r__1 = -d__[j];
	    cher_(cuplo, n, &r__1, &u_ref(1, j), &c__1, &work[1], n);
/* L10: */
	}
	...
	if (*n > 1 && *kband == 1) {
		...
		cher2_(cuplo, n, &q__1, &u_ref(1, j), &c__1, &u_ref(1, j - 1),
			 &c__1, &work[1], n);
/* L20: */
	    }
	}
...
/* Computing 2nd power */
		i__2 = *n;
		clarfy_("L", &i__1, &v_ref(j + 1, j), &c__1, &tau[j], &work[(*
...
/* Computing 2nd power */
		i__2 = *n;
		clarfy_("U", &j, &v_ref(1, j + 1), &c__1, &tau[j], &work[1], 
			n, &work[i__2 * i__2 + 1]);
		i__2 = v_subscr(j, j + 1);
...
/* Computing 2nd power */
	    i__3 = *n;
	    cunm2r_("R", "C", n, &i__1, &i__2, &v_ref(2, 1), ldv, &tau[1], &
...
/* Computing 2nd power */
	    i__3 = *n;
	    cunm2l_("R", "C", n, &i__1, &i__2, &v_ref(1, 2), ldv, &tau[1], &
