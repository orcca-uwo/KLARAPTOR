	...
	doublereal *result, integer *info)
{
    ...
    static integer nmats;
    extern /* Subroutine */ int dstt22_(integer *, integer *, integer *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, integer *, doublereal *, integer *, doublereal *);
    static integer jsize, itype, jtype, nerrs, m2, m3, ntest;
    ...
    extern /* Subroutine */ int dlasum_(char *, integer *, integer *, integer 
	    ...
	    *, doublereal *, integer *, doublereal *, doublereal *, integer *,
	    ...
	    integer *), dstedc_(char *, integer *, 
	    doublereal *, doublereal *, doublereal *, integer *, doublereal *,
	     integer *, integer *, integer *, integer *), dstegr_(
	    ...
	    *, doublereal *, integer *, integer *, doublereal *, integer *, 
	    ...
	    doublereal *, integer *, integer *, integer *), dsterf_(integer *,
	     doublereal *, doublereal *, integer *), dstebz_(char *, char *, 
	    integer *, doublereal *, doublereal *, integer *, integer *, 
	    doublereal *, doublereal *, doublereal *, integer *, integer *, 
	    doublereal *, integer *, integer *, doublereal *, integer *, 
	    integer *), xerbla_(char *, integer *), 
	    dopgtr_(char *, integer *, doublereal *, doublereal *, doublereal 
	    *, integer *, doublereal *, integer *), dpteqr_(char *, 
	    integer *, doublereal *, doublereal *, doublereal *, integer *, 
	    doublereal *, integer *), dorgtr_(char *, integer *, 
	    doublereal *, integer *, doublereal *, doublereal *, integer *, 
	    integer *), dsptrd_(char *, integer *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, integer *), 
	    dsteqr_(char *, integer *, doublereal *, doublereal *, doublereal 
	    *, integer *, doublereal *, integer *);
    static integer nsplit;
    static doublereal rtovfl;
    static integer mtypes, ntestt;
    static doublereal rtunfl, ulpinv;
...
/*              Positive definite tridiagonal, eigenvalues specified. */
		...
		for (i__ = 2; i__ <= i__3; ++i__) {
		    temp1 = (d__1 = a_ref(i__ - 1, i__), abs(d__1)) / sqrt((
			    d__2 = a_ref(i__ - 1, i__ - 1) * a_ref(i__, i__), 
			    abs(d__2)));
		    if (temp1 > .5) {
			a_ref(i__ - 1, i__) = sqrt((d__1 = a_ref(i__ - 1, i__ 
				- 1) * a_ref(i__, i__), abs(d__1))) * .5;
...
/*           Only test DSTEGR if IEEE compliant */
	    ...
	    if (ilaenv_(&c__10, "DSTEGR", "VA", &c__1, &c__0, &c__0, &c__0, (
		    ftnlen)6, (ftnlen)2) == 1 && ilaenv_(&c__11, "DSTEGR", 
...
/*           Call DSTEGR, do test 27 (relative eigenvalue accuracy)   
		...
		if (FALSE_) {
		    ...
		    abstol = unfl + unfl;
		    i__3 = *lwork - (n << 1);
		    dstegr_("V", "A", &n, &sd[1], &se[1], &vl, &vu, &il, &iu, 
			...
			s_wsfe(&io___77);
			do_fio(&c__1, "DSTEGR(V,A,rel)", (ftnlen)15);
			do_fio(&c__1, (char *)&iinfo, (ftnlen)sizeof(integer))
				;
			do_fio(&c__1, (char *)&n, (ftnlen)sizeof(integer));
			do_fio(&c__1, (char *)&jtype, (ftnlen)sizeof(integer))
...
/* L220: */
			...
			abstol = unfl + unfl;
			i__3 = *lwork - (n << 1);
			dstegr_("V", "I", &n, &sd[1], &se[1], &vl, &vu, &il, &
			...
			if (iinfo != 0) {
			    ...
			    s_wsfe(&io___78);
			    do_fio(&c__1, "DSTEGR(V,I,rel)", (ftnlen)15);
...
/*           Call DSTEGR(V,I) to compute D1 and Z, do tests.   
		...
		if (FALSE_) {
		    ...
		    i__3 = *lwork - n;
		    i__4 = *liwork - (n << 1);
		    dstegr_("V", "I", &n, &d5[1], &work[1], &vl, &vu, &il, &
			...
			s_wsfe(&io___79);
			do_fio(&c__1, "DSTEGR(V,I)", (ftnlen)11);
			do_fio(&c__1, (char *)&iinfo, (ftnlen)sizeof(integer))
				;
			do_fio(&c__1, (char *)&n, (ftnlen)sizeof(integer));
			do_fio(&c__1, (char *)&jtype, (ftnlen)sizeof(integer))
...
/*           Call DSTEGR to compute D2, do tests.   
		    ...
		    i__3 = *lwork - n;
		    i__4 = *liwork - (n << 1);
		    dstegr_("N", "I", &n, &d5[1], &work[1], &vl, &vu, &il, &
			...
			s_wsfe(&io___80);
			do_fio(&c__1, "DSTEGR(N,I)", (ftnlen)11);
			do_fio(&c__1, (char *)&iinfo, (ftnlen)sizeof(integer))
				;
			do_fio(&c__1, (char *)&n, (ftnlen)sizeof(integer));
			do_fio(&c__1, (char *)&jtype, (ftnlen)sizeof(integer))
...
/* Computing MAX */
		    ...
		    i__3 = *lwork - n;
		    i__4 = *liwork - (n << 1);
		    dstegr_("V", "V", &n, &d5[1], &work[1], &vl, &vu, &il, &
			    iu, &abstol, &m, &d1[1], &z__[z_offset], ldu, &
			    iwork[1], &work[n + 1], &i__3, &iwork[(n << 1) + 
			    1], &i__4, &iinfo);
		    if (iinfo != 0) {
			...
			s_wsfe(&io___81);
			do_fio(&c__1, "DSTEGR(V,V)", (ftnlen)11);
			do_fio(&c__1, (char *)&iinfo, (ftnlen)sizeof(integer))
				;
			do_fio(&c__1, (char *)&n, (ftnlen)sizeof(integer));
			do_fio(&c__1, (char *)&jtype, (ftnlen)sizeof(integer))
...
/*           Call DSTEGR to compute D2, do tests.   
		    ...
		    i__3 = *lwork - n;
		    i__4 = *liwork - (n << 1);
		    dstegr_("N", "V", &n, &d5[1], &work[1], &vl, &vu, &il, &
			    iu, &abstol, &m, &d2[1], &z__[z_offset], ldu, &
			    iwork[1], &work[n + 1], &i__3, &iwork[(n << 1) + 
			    1], &i__4, &iinfo);
		    if (iinfo != 0) {
			...
			s_wsfe(&io___82);
			do_fio(&c__1, "DSTEGR(N,V)", (ftnlen)11);
			do_fio(&c__1, (char *)&iinfo, (ftnlen)sizeof(integer))
				;
			do_fio(&c__1, (char *)&n, (ftnlen)sizeof(integer));
			do_fio(&c__1, (char *)&jtype, (ftnlen)sizeof(integer))
...
/*           Call DSTEGR(V,A) to compute D1 and Z, do tests.   
		...
		i__3 = *lwork - n;
		i__4 = *liwork - (n << 1);
		dstegr_("V", "A", &n, &d5[1], &work[1], &vl, &vu, &il, &iu, &
		...
		if (iinfo != 0) {
		    ...
		    s_wsfe(&io___83);
		    do_fio(&c__1, "DSTEGR(V,A)", (ftnlen)11);
		    do_fio(&c__1, (char *)&iinfo, (ftnlen)sizeof(integer));
		    do_fio(&c__1, (char *)&n, (ftnlen)sizeof(integer));
		    do_fio(&c__1, (char *)&jtype, (ftnlen)sizeof(integer));
		    do_fio(&c__4, (char *)&ioldsd[0], (ftnlen)sizeof(integer))
...
/*           Call DSTEGR to compute D2, do tests.   
		...
		i__3 = *lwork - n;
		i__4 = *liwork - (n << 1);
		dstegr_("N", "A", &n, &d5[1], &work[1], &vl, &vu, &il, &iu, &
		...
		if (iinfo != 0) {
		    ...
		    s_wsfe(&io___84);
		    do_fio(&c__1, "DSTEGR(N,A)", (ftnlen)11);
		    do_fio(&c__1, (char *)&iinfo, (ftnlen)sizeof(integer));
		    do_fio(&c__1, (char *)&n, (ftnlen)sizeof(integer));
		    do_fio(&c__1, (char *)&jtype, (ftnlen)sizeof(integer));
		    do_fio(&c__4, (char *)&ioldsd[0], (ftnlen)sizeof(integer))
