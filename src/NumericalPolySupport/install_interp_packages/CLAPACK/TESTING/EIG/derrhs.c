...
/* Subroutine */ int derrhs_(char *path, integer *nunit)
{
    ...
    static integer ifaill[3];
    static doublereal wi[3];
    static integer nt;
    static doublereal vl[9]	/* was [3][3] */;
    static integer ifailr[3];
    static doublereal vr[9]	/* was [3][3] */, wr[3];
