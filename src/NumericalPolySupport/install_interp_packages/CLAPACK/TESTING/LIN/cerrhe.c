...
/* Subroutine */ int cerrhe_(char *path, integer *nunit)
{
    ...
    extern /* Subroutine */ int checon_(char *, integer *, complex *, integer 
	    *, integer *, real *, real *, complex *, integer *), 
	    alaesm_(char *, logical *, integer *), cherfs_(char *, 
	    integer *, integer *, complex *, integer *, complex *, integer *, 
	    integer *, complex *, integer *, complex *, integer *, real *, 
	    real *, complex *, real *, integer *), chetrf_(char *, 
	    integer *, complex *, integer *, integer *, complex *, integer *, 
	    integer *), chpcon_(char *, integer *, complex *, integer 
	    *, real *, real *, complex *, integer *), chetri_(char *, 
	    integer *, complex *, integer *, integer *, complex *, integer *);
