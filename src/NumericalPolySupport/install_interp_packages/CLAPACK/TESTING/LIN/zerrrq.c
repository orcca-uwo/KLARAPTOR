...
/*     ZGERQ2 */
    ...
    s_copy(srnamc_1.srnamt, "ZGERQ2", (ftnlen)6, (ftnlen)6);
    infoc_1.infot = 1;
...
/*     ZGERQS */
    ...
    s_copy(srnamc_1.srnamt, "ZGERQS", (ftnlen)6, (ftnlen)6);
    infoc_1.infot = 1;
...
/*     ZUNGR2 */
    ...
    s_copy(srnamc_1.srnamt, "ZUNGR2", (ftnlen)6, (ftnlen)6);
    infoc_1.infot = 1;
...
/*     ZUNMR2 */
    ...
    s_copy(srnamc_1.srnamt, "ZUNMR2", (ftnlen)6, (ftnlen)6);
    infoc_1.infot = 1;
