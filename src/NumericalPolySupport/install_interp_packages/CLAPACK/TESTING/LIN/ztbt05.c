...
/* Computing MAX */
			...
			tmp += ((d__1 = ab[i__3].r, abs(d__1)) + (d__2 = 
				d_imag(&ab_ref(*kd + 1 - i__ + j, i__)), abs(
				d__2))) * ((d__3 = x[i__5].r, abs(d__3)) + (
				d__4 = d_imag(&x_ref(j, k)), abs(d__4)));
/* L40: */
		    }
		    if (unit) {
			i__4 = x_subscr(i__, k);
...
/* Computing MIN */
			...
			i__5 = x_subscr(j, k);
			tmp += ((d__1 = ab[i__3].r, abs(d__1)) + (d__2 = 
				d_imag(&ab_ref(*kd + 1 + i__ - j, j)), abs(
				d__2))) * ((d__3 = x[i__5].r, abs(d__3)) + (
				d__4 = d_imag(&x_ref(j, k)), abs(d__4)));
/* L50: */
		    }
...
/* Computing MAX */
			...
			tmp += ((d__1 = ab[i__4].r, abs(d__1)) + (d__2 = 
				d_imag(&ab_ref(i__ + 1 - j, j)), abs(d__2))) *
				 ((d__3 = x[i__5].r, abs(d__3)) + (d__4 = 
				d_imag(&x_ref(j, k)), abs(d__4)));
/* L60: */
		    }
		    if (unit) {
			i__3 = x_subscr(i__, k);
...
/* Computing MIN */
			...
			i__5 = x_subscr(j, k);
			tmp += ((d__1 = ab[i__4].r, abs(d__1)) + (d__2 = 
				d_imag(&ab_ref(j + 1 - i__, i__)), abs(d__2)))
				 * ((d__3 = x[i__5].r, abs(d__3)) + (d__4 = 
				d_imag(&x_ref(j, k)), abs(d__4)));
/* L70: */
		    }
