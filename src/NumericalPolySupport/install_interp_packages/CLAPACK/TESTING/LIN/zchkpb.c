...
/*                    Compute the L*L' or U'*U factorization of the band   
			...
			zlacpy_("Full", &i__5, &n, &a[1], &ldab, &afac[1], &
				ldab);
			s_copy(srnamc_1.srnamt, "ZPBTRF", (ftnlen)6, (ftnlen)
				6);
...
/*                    Form the inverse of A so we can get a good estimate   
			...
			zlaset_("Full", &n, &n, &c_b50, &c_b51, &ainv[1], &
				lda);
			s_copy(srnamc_1.srnamt, "ZPBTRS", (ftnlen)6, (ftnlen)
				6);
...
/* +    TESTS 4, 5, and 6   
			    ...
			    s_copy(srnamc_1.srnamt, "ZPBRFS", (ftnlen)6, (
				    ftnlen)6);
...
/* +    TEST 7   
			...
			s_copy(srnamc_1.srnamt, "ZPBCON", (ftnlen)6, (ftnlen)
				6);
