...
/* Computing MAX */
			...
			tmp += ((r__1 = ab[i__3].r, dabs(r__1)) + (r__2 = 
				r_imag(&ab_ref(*kd + 1 - i__ + j, i__)), dabs(
				r__2))) * ((r__3 = x[i__5].r, dabs(r__3)) + (
				r__4 = r_imag(&x_ref(j, k)), dabs(r__4)));
/* L40: */
		    }
		    if (unit) {
			i__4 = x_subscr(i__, k);
...
/* Computing MIN */
			...
			i__5 = x_subscr(j, k);
			tmp += ((r__1 = ab[i__3].r, dabs(r__1)) + (r__2 = 
				r_imag(&ab_ref(*kd + 1 + i__ - j, j)), dabs(
				r__2))) * ((r__3 = x[i__5].r, dabs(r__3)) + (
				r__4 = r_imag(&x_ref(j, k)), dabs(r__4)));
/* L50: */
		    }
...
/* Computing MAX */
			...
			tmp += ((r__1 = ab[i__4].r, dabs(r__1)) + (r__2 = 
				r_imag(&ab_ref(i__ + 1 - j, j)), dabs(r__2))) 
				* ((r__3 = x[i__5].r, dabs(r__3)) + (r__4 = 
				r_imag(&x_ref(j, k)), dabs(r__4)));
/* L60: */
		    }
		    if (unit) {
			i__3 = x_subscr(i__, k);
...
/* Computing MIN */
			...
			i__5 = x_subscr(j, k);
			tmp += ((r__1 = ab[i__4].r, dabs(r__1)) + (r__2 = 
				r_imag(&ab_ref(j + 1 - i__, i__)), dabs(r__2))
				) * ((r__3 = x[i__5].r, dabs(r__3)) + (r__4 = 
				r_imag(&x_ref(j, k)), dabs(r__4)));
/* L70: */
		    }
