...
/* Computing MAX */
			...
			tmp += (d__1 = ab_ref(*kd + 1 - i__ + j, i__), abs(
				d__1)) * (d__2 = x_ref(j, k), abs(d__2));
/* L40: */
		    }
		    if (unit) {
			tmp += (d__1 = x_ref(i__, k), abs(d__1));
		    }
		} else {
		    if (unit) {
			tmp += (d__1 = x_ref(i__, k), abs(d__1));
...
/* Computing MIN */
			...
			tmp += (d__1 = ab_ref(*kd + 1 + i__ - j, j), abs(d__1)
				) * (d__2 = x_ref(j, k), abs(d__2));
/* L50: */
		    }
		}
	    } else {
...
/* Computing MAX */
			...
			tmp += (d__1 = ab_ref(i__ + 1 - j, j), abs(d__1)) * (
				d__2 = x_ref(j, k), abs(d__2));
/* L60: */
		    }
		    if (unit) {
...
/* Computing MIN */
			...
			tmp += (d__1 = ab_ref(j + 1 - i__, i__), abs(d__1)) * 
				(d__2 = x_ref(j, k), abs(d__2));
/* L70: */
		    }
		}
