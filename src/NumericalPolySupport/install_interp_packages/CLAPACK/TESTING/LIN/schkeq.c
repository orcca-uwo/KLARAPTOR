...
/* Subroutine */ int schkeq_(real *thresh, integer *nout)
{
    ...
    static integer info;
    static char path[3];
    static real norm, rpow[11], a[25]	/* was [5][5] */, c__[5];
    static integer i__, j, m, n;
    static real r__[5], ccond, rcond, rcmin, rcmax, ratio, ab[65]	/* 
	    was [13][5] */, ap[15];
    static integer kl;
    static logical ok;
    static integer ku;
