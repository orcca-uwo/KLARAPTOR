...
/* Main program */ MAIN__(void)
{
    ...
    static char fmt_9994[] = "(\002 Tests of the REAL LAPACK routines \002,"
	    "/\002 LAPACK VERSION 3.0, released June 30, 1999 \002,//\002 The"
	    " following parameter values will be used:\002)";
    ...
    static real work[23496]	/* was [132][178] */, a[153384]	/* was [21912]
	    [7] */, b[8448]	/* was [2112][4] */;
    ...
    static real s1, s2, rwork[692];
    static integer nbval2[12];
    extern /* Subroutine */ int schkq3_(logical *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, integer *, real *, 
	    real *, real *, real *, real *, real *, real *, integer *, 
	    integer *);
    static integer ic, la, nb, nm, nn;
    extern /* Subroutine */ int schkgb_(logical *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, integer *, integer *, 
	    real *, logical *, real *, integer *, real *, integer *, real *, 
	    real *, real *, real *, real *, integer *, integer *), schkge_(
	    logical *, integer *, integer *, integer *, integer *, integer *, 
	    integer *, integer *, integer *, real *, logical *, integer *, 
	    real *, real *, real *, real *, real *, real *, real *, real *, 
	    integer *, integer *), alareq_(char *, integer *, logical *, 
    ...
    extern /* Subroutine */ int schktb_(logical *, integer *, integer *, 
	    ...
	    schkgt_(logical *, integer *, integer *, integer *, integer *, 
	    real *, logical *, real *, real *, real *, real *, real *, real *,
	     real *, integer *, integer *), schklq_(logical *, integer *, 
	    integer *, integer *, integer *, integer *, integer *, integer *, 
	    integer *, real *, logical *, integer *, real *, real *, real *, 
	    real *, real *, real *, real *, real *, real *, real *, real *, 
	    integer *, integer *), schkql_(logical *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, integer *, integer *, 
	    ...
	    real *, real *, integer *, integer *), schkqr_(logical *, integer 
	    *, integer *, integer *, integer *, integer *, integer *, integer 
	    *, integer *, real *, logical *, integer *, real *, real *, real *
	    , real *, real *, real *, real *, real *, real *, real *, real *, 
	    integer *, integer *), schkpt_(logical *, integer *, integer *, 
	    integer *, integer *, real *, logical *, real *, real *, real *, 
	    real *, real *, real *, real *, real *, integer *);
    static real thresh;
    extern /* Subroutine */ int schkrq_(logical *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, integer *, integer *, 
	    real *, logical *, integer *, real *, real *, real *, real *, 
	    real *, real *, real *, real *, real *, real *, real *, integer *,
	     integer *), schksp_(logical *, integer *, integer *, integer *, 
	    integer *, real *, logical *, integer *, real *, real *, real *, 
	    real *, real *, real *, real *, real *, integer *, integer *);
    static logical tstchk;
    extern /* Subroutine */ int schktp_(logical *, integer *, integer *, 
	    integer *, integer *, real *, logical *, integer *, real *, real *
	    , real *, real *, real *, real *, real *, integer *, integer *), 
	    schktr_(logical *, integer *, integer *, integer *, integer *, 
	    integer *, integer *, real *, logical *, integer *, real *, real *
	    , real *, real *, real *, real *, real *, integer *, integer *);
    ...
    extern /* Subroutine */ int schksy_(logical *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, real *, logical *, 
	    integer *, real *, real *, real *, real *, real *, real *, real *,
	     real *, integer *, integer *), schktz_(logical *, integer *, 
	    integer *, integer *, integer *, real *, logical *, real *, real *
	    , real *, real *, real *, real *, integer *), sdrvgb_(logical *, 
	    integer *, integer *, integer *, real *, logical *, real *, 
	    integer *, real *, integer *, real *, real *, real *, real *, 
	    real *, real *, real *, real *, integer *, integer *), sdrvge_(
	    logical *, integer *, integer *, integer *, real *, logical *, 
	    integer *, real *, real *, real *, real *, real *, real *, real *,
	     real *, real *, real *, integer *, integer *), sdrvgt_(logical *,
	     integer *, integer *, integer *, real *, logical *, real *, real 
	    *, real *, real *, real *, real *, real *, integer *, integer *), 
	    sdrvpb_(logical *, integer *, integer *, integer *, real *, 
	    logical *, integer *, real *, real *, real *, real *, real *, 
	    real *, real *, real *, real *, real *, integer *, integer *), 
	    sdrvls_(logical *, integer *, integer *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, integer *, real *, 
	    logical *, real *, real *, real *, real *, real *, real *, real *,
	     real *, integer *, integer *), sdrvpo_(logical *, integer *, 
	    integer *, integer *, real *, logical *, integer *, real *, real *
	    , real *, real *, real *, real *, real *, real *, real *, real *, 
	    integer *, integer *), sdrvpp_(logical *, integer *, integer *, 
	    integer *, real *, logical *, integer *, real *, real *, real *, 
	    real *, real *, real *, real *, real *, real *, real *, integer *,
	     integer *), sdrvsp_(logical *, integer *, integer *, integer *, 
	    real *, logical *, integer *, real *, real *, real *, real *, 
...
/*        GE:  general matrices */
	...
	if (tstdrv) {
	    sdrvge_(dotype, &nn, nval, &nrhs, &thresh, &tsterr, &lda, &a_ref(
...
/*        GB:  general banded matrices */
	...
	if (tstdrv) {
	    sdrvgb_(dotype, &nn, nval, &nrhs, &thresh, &tsterr, &a_ref(1, 1), 
...
/*        GT:  general tridiagonal matrices */
	...
	if (tstchk) {
	    schkgt_(dotype, &nn, nval, &nns, nsval, &thresh, &tsterr, &a_ref(
	...
	if (tstdrv) {
	    sdrvgt_(dotype, &nn, nval, &nrhs, &thresh, &tsterr, &a_ref(1, 1), 
...
/*        PO:  positive definite matrices */
	...
	if (tstdrv) {
	    sdrvpo_(dotype, &nn, nval, &nrhs, &thresh, &tsterr, &lda, &a_ref(
		    1, 1), &a_ref(1, 2), &a_ref(1, 3), &b_ref(1, 1), &b_ref(1,
		     2), &b_ref(1, 3), &b_ref(1, 4), s, work, rwork, iwork, &
		    c__6);
	} else {
...
/*        PP:  positive definite packed matrices */
	...
	if (tstchk) {
	    schkpp_(dotype, &nn, nval, &nns, nsval, &thresh, &tsterr, &lda, &
	...
	if (tstdrv) {
	    sdrvpp_(dotype, &nn, nval, &nrhs, &thresh, &tsterr, &lda, &a_ref(
		    1, 1), &a_ref(1, 2), &a_ref(1, 3), &b_ref(1, 1), &b_ref(1,
		     2), &b_ref(1, 3), &b_ref(1, 4), s, work, rwork, iwork, &
		    c__6);
	} else {
...
/*        PB:  positive definite banded matrices */
	...
	if (tstdrv) {
	    sdrvpb_(dotype, &nn, nval, &nrhs, &thresh, &tsterr, &lda, &a_ref(
		    1, 1), &a_ref(1, 2), &a_ref(1, 3), &b_ref(1, 1), &b_ref(1,
		     2), &b_ref(1, 3), &b_ref(1, 4), s, work, rwork, iwork, &
		    c__6);
	} else {
...
/*        PT:  positive definite tridiagonal matrices */
	...
	if (tstchk) {
	    schkpt_(dotype, &nn, nval, &nns, nsval, &thresh, &tsterr, &a_ref(
		    1, 1), &a_ref(1, 2), &a_ref(1, 3), &b_ref(1, 1), &b_ref(1,
	...
	if (tstdrv) {
	    sdrvpt_(dotype, &nn, nval, &nrhs, &thresh, &tsterr, &a_ref(1, 1), 
...
/*        SY:  symmetric indefinite matrices */
	...
	if (tstdrv) {
	    sdrvsy_(dotype, &nn, nval, &nrhs, &thresh, &tsterr, &lda, &a_ref(
		    1, 1), &a_ref(1, 2), &a_ref(1, 3), &b_ref(1, 1), &b_ref(1,
...
/*        SP:  symmetric indefinite packed matrices */
	...
	if (tstchk) {
	    schksp_(dotype, &nn, nval, &nns, nsval, &thresh, &tsterr, &lda, &
		    a_ref(1, 1), &a_ref(1, 2), &a_ref(1, 3), &b_ref(1, 1), &
		    b_ref(1, 2), &b_ref(1, 3), work, rwork, iwork, &c__6);
	} else {
	    s_wsfe(&io___104);
	...
	if (tstdrv) {
	    sdrvsp_(dotype, &nn, nval, &nrhs, &thresh, &tsterr, &lda, &a_ref(
		    1, 1), &a_ref(1, 2), &a_ref(1, 3), &b_ref(1, 1), &b_ref(1,
		     2), &b_ref(1, 3), work, rwork, iwork, &c__6);
	} else {
	    s_wsfe(&io___105);
...
/*        TP:  triangular packed matrices */
	...
	if (tstchk) {
	    schktp_(dotype, &nn, nval, &nns, nsval, &thresh, &tsterr, &lda, &
...
/*        TB:  triangular banded matrices */
	...
	if (tstchk) {
	    schktb_(dotype, &nn, nval, &nns, nsval, &thresh, &tsterr, &lda, &
		    a_ref(1, 1), &a_ref(1, 2), &b_ref(1, 1), &b_ref(1, 2), &
		    b_ref(1, 3), work, rwork, iwork, &c__6);
	} else {
	    s_wsfe(&io___108);
...
/*        QP:  QR factorization with pivoting */
	...
	if (tstchk) {
	    schkqp_(dotype, &nm, mval, &nn, nval, &thresh, &tsterr, &a_ref(1, 
...
/*        TZ:  Trapezoidal matrix */
	...
	if (tstchk) {
	    schktz_(dotype, &nm, mval, &nn, nval, &thresh, &tsterr, &a_ref(1, 
		    1), &a_ref(1, 2), &b_ref(1, 1), &b_ref(1, 2), &b_ref(1, 3)
		    , work, &c__6);
	} else {
	    s_wsfe(&io___114);
