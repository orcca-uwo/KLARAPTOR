	...
	doublereal *work, doublereal *rwork, integer *iwork, integer *nout)
{
    ...
    static char trans[1];
    static integer izero, nerrs, k1, lwork;
    ...
    static doublereal colcnd, rcondc;
...
/*                       --- Test DGESV  ---   
			    ...
			    s_copy(srnamc_1.srnamt, "DGESV ", (ftnlen)6, (
				    ftnlen)6);
...
/*                    Solve the system and compute the condition number   
			...
			s_copy(srnamc_1.srnamt, "DGESVX", (ftnlen)6, (ftnlen)
				6);
