...
/*              Call ZLATTP to generate a triangular test matrix. */
		...
		s_copy(srnamc_1.srnamt, "ZLATTP", (ftnlen)6, (ftnlen)6);
...
/* +    TEST 2   
			...
			*(unsigned char *)xtype = 'C';
			...
			s_copy(srnamc_1.srnamt, "ZTPTRS", (ftnlen)6, (ftnlen)
				6);
...
/* +    TESTS 4, 5, and 6   
			...
			s_copy(srnamc_1.srnamt, "ZTPRFS", (ftnlen)6, (ftnlen)
				6);
