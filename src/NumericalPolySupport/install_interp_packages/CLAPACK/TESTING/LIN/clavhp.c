...
/*              Multiply by the diagonal element if forming U * D. */
		...
		if (nounit) {
		    cscal_(nrhs, &a[kc + k - 1], &b_ref(k, 1), ldb);
		}
...
/*                 Apply the transformation. */
		    ...
		    i__1 = k - 1;
		    cgeru_(&i__1, nrhs, &c_b1, &a[kc], &c__1, &b_ref(k, 1), 
			    ldb, &b_ref(1, 1), ldb);
...
/*                 Apply the transformations. */
		    ...
		    cgeru_(&i__1, nrhs, &c_b1, &a[kc], &c__1, &b_ref(k, 1), 
			    ldb, &b_ref(1, 1), ldb);
		    i__1 = k - 1;
		    cgeru_(&i__1, nrhs, &c_b1, &a[kcnext], &c__1, &b_ref(k + 
...
/*              1 x 1 pivot block:   
		...
		if (nounit) {
		    cscal_(nrhs, &a[kc], &b_ref(k, 1), ldb);
		}
...
/*                 Apply the transformation. */
		    ...
		    i__1 = *n - k;
		    cgeru_(&i__1, nrhs, &c_b1, &a[kc + 1], &c__1, &b_ref(k, 1)
			    , ldb, &b_ref(k + 1, 1), ldb);
...
/*                 Apply the transformation. */
		    ...
		    cgeru_(&i__1, nrhs, &c_b1, &a[kc + 1], &c__1, &b_ref(k, 1)
			    , ldb, &b_ref(k + 1, 1), ldb);
		    i__1 = *n - k;
		    cgeru_(&i__1, nrhs, &c_b1, &a[kcnext + 2], &c__1, &b_ref(
...
/*                 Apply the transformation */
		    ...
		    clacgv_(nrhs, &b_ref(k, 1), ldb);
		    i__1 = *n - k;
		    cgemv_("Conjugate", &i__1, nrhs, &c_b1, &b_ref(k + 1, 1), 
...
/*                 Apply the transformation */
		    ...
		    clacgv_(nrhs, &b_ref(k + 1, 1), ldb);
		    i__1 = *n - k - 1;
		    cgemv_("Conjugate", &i__1, nrhs, &c_b1, &b_ref(k + 2, 1), 
