...
/* Subroutine */ int cerrrq_(char *path, integer *nunit)
{
    ...
    extern /* Subroutine */ int alaesm_(char *, logical *, integer *),
	     cgerqf_(integer *, integer *, complex *, integer *, complex *, 
	    complex *, integer *, integer *), cgerqs_(integer *, integer *, 
	    integer *, complex *, integer *, complex *, complex *, integer *, 
	    complex *, integer *, integer *), chkxer_(char *, integer *, 
	    integer *, logical *, logical *), cungrq_(integer *, 
	    integer *, integer *, complex *, integer *, complex *, complex *, 
	    integer *, integer *), cunmrq_(char *, char *, integer *, integer 
	    *, integer *, complex *, integer *, complex *, complex *, integer 
