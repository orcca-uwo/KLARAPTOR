...
/*           Compute the (K,K) element of the result. */
	    ...
	    i__1 = klen + 1;
	    cdotc_(&q__1, &i__1, &afac_ref(kc, k), &c__1, &afac_ref(kc, k), &
		    c__1);
	    akk = q__1.r;
...
/*           Compute the rest of column K. */
	    ...
	    if (klen > 0) {
		i__1 = *ldafac - 1;
		ctrmv_("Upper", "Conjugate", "Non-unit", &klen, &afac_ref(*kd 
...
/*           Add a multiple of column K of the factor L to each of   
	    ...
	    if (klen > 0) {
		i__1 = *ldafac - 1;
		cher_("Lower", &klen, &c_b17, &afac_ref(2, k), &c__1, &
			afac_ref(1, k + 1), &i__1);
	    }
...
/*           Scale column K by the diagonal element. */
	    ...
	    akk = afac[i__1].r;
	    i__1 = klen + 1;
	    csscal_(&i__1, &akk, &afac_ref(1, k), &c__1);
