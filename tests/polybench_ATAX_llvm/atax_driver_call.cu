...
///////////////////////////////////////
///////////////////////////////////////
const int kernel_info_size_param_idx_atax_kernel1 __attribute__((used))  = 3;
const int kernel_info_dim_atax_kernel1 __attribute__((used))  = 2;
const int kernel_info_size_param_idx_atax_kernel2 __attribute__((used))  = 3;
const int kernel_info_dim_atax_kernel2 __attribute__((used))  = 2;
void
...
void
ataxGpu (DATA_TYPE* A, DATA_TYPE* x, DATA_TYPE* y, DATA_TYPE* tmp,  DATA_TYPE* y_outputFromGpu)
{
 ...
 char kernel_atax_kernel1_0_name[] = "kernel_atax_kernel1_sm_75";
 
 //launch_params: 3 for grid_dim, 3 for block_dim, 1 for dynamic_shared_mem_bytes;
 int kernel_atax_kernel1_sm_75_0_launch_params[6];
 set_kernel_launch_params(kernel_atax_kernel1_sm_75_0_launch_params, grid1, block);
 
 void * kernel_atax_kernel1_sm_75_0_kernel_params[]={&A_gpu , &x_gpu , &tmp_gpu , &NX , &NY};
 
 kernel_invoker(kernel_atax_kernel1_0_name, kernel_atax_kernel1_sm_75_0_launch_params, kernel_atax_kernel1_sm_75_0_kernel_params);
 ...
 char kernel_atax_kernel2_0_name[] = "kernel_atax_kernel2_sm_75";
 
 //launch_params: 3 for grid_dim, 3 for block_dim, 1 for dynamic_shared_mem_bytes;
 int kernel_atax_kernel2_sm_75_0_launch_params[6];
 set_kernel_launch_params(kernel_atax_kernel2_sm_75_0_launch_params, grid2, block);
 
 void * kernel_atax_kernel2_sm_75_0_kernel_params[]={&A_gpu , &y_gpu , &tmp_gpu , &NX , &NY};
 
 kernel_invoker(kernel_atax_kernel2_0_name, kernel_atax_kernel2_sm_75_0_launch_params, kernel_atax_kernel2_sm_75_0_kernel_params);
 ...
 ////////////////////////////////////////////////////////////////////////
  ...
  printf ("[trace: n=%d, bx=%d, by=%d, "
   ...
   "elapsed_atax_kernel2=%0.4f (ms)] ... ",   NX, DIM_THREAD_BLOCK_X, DIM_THREAD_BLOCK_Y, t1.elapsed_time,   t2.elapsed_time);
  cudaFree (A_gpu);
  cudaFree (x_gpu);
  cudaFree (y_gpu);
  cudaFree (tmp_gpu);
