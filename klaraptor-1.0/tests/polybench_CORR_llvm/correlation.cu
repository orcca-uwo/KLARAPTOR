...
#pragma kernel_info_size_param_idx_std_kernel = 3;
#pragma kernel_info_dim_std_kernel = 2;

#pragma kernel_info_size_param_idx_reduce_kernel = 3;
#pragma kernel_info_dim_reduce_kernel = 2;

#pragma kernel_info_size_param_idx_corr_kernel = 2;
#pragma kernel_info_dim_corr_kernel = 2;
...
void
correlation (DATA_TYPE* data, DATA_TYPE* mean, DATA_TYPE* stddev,
	     DATA_TYPE* symmat)
{
  int i, j, j1, j2;
...
void
correlationCuda (DATA_TYPE* data, DATA_TYPE* mean, DATA_TYPE* stddev,
...
//  fprintf (stdout, "GPU Runtime: %0.6lfs\n", t_end - t_start);
  ...
  printf ("[trace: n=%d, bx=%d, by=%d, "
	  ...
	  " elapsed_corr_kernel=%0.4f (ms)] ... ",
	  M, DIM_THREAD_BLOCK_KERNEL_4_X, DIM_THREAD_BLOCK_KERNEL_4_Y,
	  t1.elapsed_time, t2.elapsed_time, t3.elapsed_time, t4.elapsed_time);
