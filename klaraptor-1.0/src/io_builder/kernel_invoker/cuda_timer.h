/*!
 ...
 \brief This header includes a set of functions simplifying use of CUDA timers.
 */
...
void cuda_timer_init(cuda_timer& t, char *name = NULL) {
...
void cuda_timer_record_start(cuda_timer&t) {
	cudaEventRecord(t.start, 0);
}

///////////////////////////////////////////////////////////

void cuda_timer_init_record_start(cuda_timer&t) {
	cuda_timer_init(t);
...
void cuda_timer_record_stop(cuda_timer&t) {
	cudaEventRecord(t.stop, 0);
}

///////////////////////////////////////////////////////////

void cuda_timer_print_elapsed_time(float elapsed_time, char*msg) {
...
void cuda_timer_print_elapsed_time_for_bandwidth(usfixn64 data_size_bytes,
		float elapsed_time_ms, char*msg) {
...
void cuda_timer_record_get_elapsed_time(cuda_timer&t, char*msg = NULL) {
...
void cuda_timer_destroy(cuda_timer & t) {
